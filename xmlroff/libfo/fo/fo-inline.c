...
#include "fo/fo-inline-private.h"
...
static void fo_inline_cbpbp_fo_init (FoCBPBPFoIface *iface);
...
fo_inline_get_type (void)
{
  ...
  if (!object_type)
	...
	(GInterfaceInitFunc) fo_inline_inline_fo_init, /* interface_init */
      ...
      {
	(GInterfaceInitFunc) fo_inline_cbpbp_fo_init,	 /* interface_init */
        NULL,
        NULL
      };
...
/**
 * fo_inline_cbpbp_fo_init:
 * @iface: #FoCBPBPFoIFace structure for this class.
 * 
 * Initialize #FoCBPBPFoIface interface for this class.
 **/
void
fo_inline_cbpbp_fo_init (FoCBPBPFoIface *iface)
{
  iface->get_background_color = fo_inline_get_background_color;
  iface->get_border_after_color = fo_inline_get_border_after_color;
  iface->get_border_after_style = fo_inline_get_border_after_style;
  iface->get_border_after_width = fo_inline_get_border_after_width;
  iface->get_border_before_color = fo_inline_get_border_before_color;
  iface->get_border_before_style = fo_inline_get_border_before_style;
  iface->get_border_before_width = fo_inline_get_border_before_width;
  iface->get_border_end_color = fo_inline_get_border_end_color;
  iface->get_border_end_style = fo_inline_get_border_end_style;
  iface->get_border_end_width = fo_inline_get_border_end_width;
  iface->get_border_start_color = fo_inline_get_border_start_color;
  iface->get_border_start_style = fo_inline_get_border_start_style;
  iface->get_border_start_width = fo_inline_get_border_start_width;
  iface->get_padding_after = fo_inline_get_padding_after;
  iface->get_padding_before = fo_inline_get_padding_before;
  iface->get_padding_end = fo_inline_get_padding_end;
  iface->get_padding_start = fo_inline_get_padding_start;
}
...
fo_inline_finalize (GObject *object)
{
  ...
  fo_inline_set_alignment_adjust (fo, NULL);
  fo_inline_set_alignment_baseline (fo, NULL);
  fo_inline_set_background_color (fo, NULL);
  fo_inline_set_background_image (fo, NULL);
  fo_inline_set_baseline_shift (fo, NULL);
  fo_inline_set_block_progression_dimension (fo, NULL);
  fo_inline_set_border_after_color (fo, NULL);
  fo_inline_set_border_after_style (fo, NULL);
  fo_inline_set_border_after_width (fo, NULL);
  fo_inline_set_border_before_color (fo, NULL);
  fo_inline_set_border_before_style (fo, NULL);
  fo_inline_set_border_before_width (fo, NULL);
  fo_inline_set_border_bottom_color (fo, NULL);
  fo_inline_set_border_bottom_style (fo, NULL);
  fo_inline_set_border_bottom_width (fo, NULL);
  fo_inline_set_border_end_color (fo, NULL);
  fo_inline_set_border_end_style (fo, NULL);
  fo_inline_set_border_end_width (fo, NULL);
  fo_inline_set_border_left_color (fo, NULL);
  fo_inline_set_border_left_style (fo, NULL);
  fo_inline_set_border_left_width (fo, NULL);
  fo_inline_set_border_right_color (fo, NULL);
  fo_inline_set_border_right_style (fo, NULL);
  fo_inline_set_border_right_width (fo, NULL);
  fo_inline_set_border_start_color (fo, NULL);
  fo_inline_set_border_start_style (fo, NULL);
  fo_inline_set_border_start_width (fo, NULL);
  fo_inline_set_border_top_color (fo, NULL);
  fo_inline_set_border_top_style (fo, NULL);
  fo_inline_set_border_top_width (fo, NULL);
  fo_inline_set_color (fo, NULL);
  fo_inline_set_dominant_baseline (fo, NULL);
  fo_inline_set_font_family (fo, NULL);
  fo_inline_set_font_size (fo, NULL);
  fo_inline_set_font_stretch (fo, NULL);
  fo_inline_set_font_style (fo, NULL);
  fo_inline_set_font_variant (fo, NULL);
  fo_inline_set_font_weight (fo, NULL);
  fo_inline_set_height (fo, NULL);
  fo_inline_set_id (fo, NULL);
  fo_inline_set_inline_progression_dimension (fo, NULL);
  fo_inline_set_keep_together (fo, NULL);
  fo_inline_set_keep_together_within_column (fo, NULL);
  fo_inline_set_keep_together_within_line (fo, NULL);
  fo_inline_set_keep_together_within_page (fo, NULL);
  fo_inline_set_keep_with_next (fo, NULL);
  fo_inline_set_keep_with_next_within_column (fo, NULL);
  fo_inline_set_keep_with_next_within_line (fo, NULL);
  fo_inline_set_keep_with_next_within_page (fo, NULL);
  fo_inline_set_keep_with_previous (fo, NULL);
  fo_inline_set_keep_with_previous_within_column (fo, NULL);
  fo_inline_set_keep_with_previous_within_line (fo, NULL);
  fo_inline_set_keep_with_previous_within_page (fo, NULL);
  fo_inline_set_line_height (fo, NULL);
  fo_inline_set_padding_after (fo, NULL);
  fo_inline_set_padding_before (fo, NULL);
  fo_inline_set_padding_bottom (fo, NULL);
  fo_inline_set_padding_end (fo, NULL);
  fo_inline_set_padding_left (fo, NULL);
  fo_inline_set_padding_right (fo, NULL);
  fo_inline_set_padding_start (fo, NULL);
  fo_inline_set_padding_top (fo, NULL);
  fo_inline_set_role (fo, NULL);
  fo_inline_set_source_document (fo, NULL);
  fo_inline_set_space_end (fo, NULL);
  fo_inline_set_space_start (fo, NULL);
  fo_inline_set_width (fo, NULL);
  fo_inline_set_wrap_option (fo, NULL);
...
fo_inline_new (void)
{
  return FO_FO (g_object_new (fo_inline_get_type (),
                              NULL));
}
 ...
 **/
void
fo_inline_debug_dump_properties (FoFo *fo,
                                 gint  depth)
{
  FoInline *fo_inline;
