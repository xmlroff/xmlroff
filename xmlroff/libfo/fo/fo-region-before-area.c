/* Fo
 * fo-region-before-area.c: Generate area for 'region-before' formatting object
 *
			   ...
			   GError             **error)
{
  ...
  *new_area = g_object_ref_sink (fo_area_region_new ());
  ...
  fo_area_set_available_height (*new_area,
