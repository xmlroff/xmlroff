...
fo_character_finalize (GObject *object)
{
  ...
  fo_character_set_alignment_adjust (fo, NULL);
  fo_character_set_alignment_baseline (fo, NULL);
  fo_character_set_background_color (fo, NULL);
  fo_character_set_background_image (fo, NULL);
  fo_character_set_baseline_shift (fo, NULL);
  fo_character_set_border_after_color (fo, NULL);
  fo_character_set_border_after_style (fo, NULL);
  fo_character_set_border_after_width (fo, NULL);
  fo_character_set_border_before_color (fo, NULL);
  fo_character_set_border_before_style (fo, NULL);
  fo_character_set_border_before_width (fo, NULL);
  fo_character_set_border_bottom_color (fo, NULL);
  fo_character_set_border_bottom_style (fo, NULL);
  fo_character_set_border_bottom_width (fo, NULL);
  fo_character_set_border_end_color (fo, NULL);
  fo_character_set_border_end_style (fo, NULL);
  fo_character_set_border_end_width (fo, NULL);
  fo_character_set_border_left_color (fo, NULL);
  fo_character_set_border_left_style (fo, NULL);
  fo_character_set_border_left_width (fo, NULL);
  fo_character_set_border_right_color (fo, NULL);
  fo_character_set_border_right_style (fo, NULL);
  fo_character_set_border_right_width (fo, NULL);
  fo_character_set_border_start_color (fo, NULL);
  fo_character_set_border_start_style (fo, NULL);
  fo_character_set_border_start_width (fo, NULL);
  fo_character_set_border_top_color (fo, NULL);
  fo_character_set_border_top_style (fo, NULL);
  fo_character_set_border_top_width (fo, NULL);
  fo_character_set_character (fo, NULL);
  fo_character_set_color (fo, NULL);
  fo_character_set_dominant_baseline (fo, NULL);
  fo_character_set_font_family (fo, NULL);
  fo_character_set_font_size (fo, NULL);
  fo_character_set_font_stretch (fo, NULL);
  fo_character_set_font_style (fo, NULL);
  fo_character_set_font_variant (fo, NULL);
  fo_character_set_font_weight (fo, NULL);
  fo_character_set_id (fo, NULL);
  fo_character_set_keep_with_next (fo, NULL);
  fo_character_set_keep_with_next_within_column (fo, NULL);
  fo_character_set_keep_with_next_within_line (fo, NULL);
  fo_character_set_keep_with_next_within_page (fo, NULL);
  fo_character_set_keep_with_previous (fo, NULL);
  fo_character_set_keep_with_previous_within_column (fo, NULL);
  fo_character_set_keep_with_previous_within_line (fo, NULL);
  fo_character_set_keep_with_previous_within_page (fo, NULL);
  fo_character_set_line_height (fo, NULL);
  fo_character_set_padding_after (fo, NULL);
  fo_character_set_padding_before (fo, NULL);
  fo_character_set_padding_bottom (fo, NULL);
  fo_character_set_padding_end (fo, NULL);
  fo_character_set_padding_left (fo, NULL);
  fo_character_set_padding_right (fo, NULL);
  fo_character_set_padding_start (fo, NULL);
  fo_character_set_padding_top (fo, NULL);
  fo_character_set_score_spaces (fo, NULL);
  fo_character_set_space_end (fo, NULL);
  fo_character_set_space_start (fo, NULL);
                       ...
                       GError   **error)
{
  ...
  FoEnumEnum linefeed_treatment =
    fo_enum_get_value (fo_property_get_value (fo_context_get_linefeed_treatment (current_context)));

  const gchar *character =
    fo_char_get_value (fo_property_get_value (fo_character_get_character (fo)));
  if (fo_inline_fo_is_linefeed (character) &&
      linefeed_treatment != FO_ENUM_ENUM_PRESERVE)
    {
      FoProperty *new_character_prop = NULL;

      switch (linefeed_treatment)
	{
	case FO_ENUM_ENUM_IGNORE:
	  new_character_prop = NULL;
	  break;
	case FO_ENUM_ENUM_TREAT_AS_SPACE:
	  new_character_prop = g_object_new (FO_TYPE_PROPERTY_CHARACTER,
					     "value",
				 ...
				 guint    debug_level G_GNUC_UNUSED)
{
  ...
  FoCharacter *fo_character = FO_CHARACTER (fo_inline_fo);
  FoProperty *character_prop = fo_character_get_character (fo_inline_fo);

  /* The character may have been a linefeed that was discarded. */
  if (character_prop == NULL)
    {
      return;
    }

  gint start_index = text->len;

  g_string_append (text,
		   fo_char_get_value (fo_property_get_value (character_prop)));

  gint end_index = text->len;
