...
static void fo_table_header_cbpbp_fo_init (FoCBPBPFoIface *iface);
...
fo_table_header_get_type (void)
{
  ...
  if (!object_type)
	...
	{
	  (GInterfaceInitFunc) fo_table_header_cbpbp_fo_init,	 /* interface_init */
	  NULL,
	  NULL
	};
...
fo_table_header_cbpbp_fo_init (FoCBPBPFoIface *iface)
{
  ...
  iface->get_padding_after = fo_table_header_get_padding_after;
  iface->get_padding_before = fo_table_header_get_padding_before;
  iface->get_padding_end = fo_table_header_get_padding_end;
  iface->get_padding_start = fo_table_header_get_padding_start;
}
...
fo_table_header_finalize (GObject *object)
{
  ...
  fo_table_header_set_background_color (fo, NULL);
  fo_table_header_set_background_image (fo, NULL);
  fo_table_header_set_border_after_color (fo, NULL);
  fo_table_header_set_border_after_precedence (fo, NULL);
  fo_table_header_set_border_after_style (fo, NULL);
  fo_table_header_set_border_after_width (fo, NULL);
  fo_table_header_set_border_before_color (fo, NULL);
  fo_table_header_set_border_before_precedence (fo, NULL);
  fo_table_header_set_border_before_style (fo, NULL);
  fo_table_header_set_border_before_width (fo, NULL);
  fo_table_header_set_border_bottom_color (fo, NULL);
  fo_table_header_set_border_bottom_style (fo, NULL);
  fo_table_header_set_border_bottom_width (fo, NULL);
  fo_table_header_set_border_end_color (fo, NULL);
  fo_table_header_set_border_end_precedence (fo, NULL);
  fo_table_header_set_border_end_style (fo, NULL);
  fo_table_header_set_border_end_width (fo, NULL);
  fo_table_header_set_border_left_color (fo, NULL);
  fo_table_header_set_border_left_style (fo, NULL);
  fo_table_header_set_border_left_width (fo, NULL);
  fo_table_header_set_border_right_color (fo, NULL);
  fo_table_header_set_border_right_style (fo, NULL);
  fo_table_header_set_border_right_width (fo, NULL);
  fo_table_header_set_border_start_color (fo, NULL);
  fo_table_header_set_border_start_precedence (fo, NULL);
  fo_table_header_set_border_start_style (fo, NULL);
  fo_table_header_set_border_start_width (fo, NULL);
  fo_table_header_set_border_top_color (fo, NULL);
  fo_table_header_set_border_top_style (fo, NULL);
  fo_table_header_set_border_top_width (fo, NULL);
  fo_table_header_set_id (fo, NULL);
  fo_table_header_set_padding_after (fo, NULL);
  fo_table_header_set_padding_before (fo, NULL);
  fo_table_header_set_padding_bottom (fo, NULL);
  fo_table_header_set_padding_end (fo, NULL);
  fo_table_header_set_padding_left (fo, NULL);
  fo_table_header_set_padding_right (fo, NULL);
  fo_table_header_set_padding_start (fo, NULL);
  fo_table_header_set_padding_top (fo, NULL);
  fo_table_header_set_role (fo, NULL);
  fo_table_header_set_source_document (fo, NULL);
 ...
 **/
void
fo_table_header_debug_dump_properties (FoFo *fo,
                                       gint  depth)
{
