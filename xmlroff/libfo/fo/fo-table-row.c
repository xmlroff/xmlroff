/* Fo
 * fo-table-row.c: 'table-row' formatting object
 *
...
#include "fo/fo-table-row-private.h"
#include "fo/fo-table-row-area.h"
...
static void fo_table_row_class_init  (FoTableRowClass *klass);
static void fo_table_row_cbpbp_fo_init (FoCBPBPFoIface *iface);
static void fo_table_row_table_border_fo_init (FoTableBorderFoIface *iface);
static void fo_table_row_get_property (GObject      *object,
                                       guint         prop_id,
                                       GValue       *value,
                                       GParamSpec   *pspec);
static void fo_table_row_set_property (GObject      *object,
                                       guint         prop_id,
                                       const GValue *value,
                                       GParamSpec   *pspec);
static void fo_table_row_finalize    (GObject           *object);
static gboolean fo_table_row_validate_content (FoFo    *fo,
                                               GError **error);
static void fo_table_row_validate (FoFo      *fo,
                                   FoContext *current_context,
                                   FoContext *parent_context,
                                   GError   **error);
static void fo_table_row_update_from_context (FoFo      *fo,
                                              FoContext *context);
static void fo_table_row_debug_dump_properties (FoFo *fo,
                                                gint  depth);

static gpointer parent_class;

/**
 * fo_table_row_get_type:
 * 
...
fo_table_row_get_type (void)
{
  ...
  if (!object_type)
	...
	{
	  sizeof (FoTableRowClass),
	  NULL,           /* base_init */
	  NULL,           /* base_finalize */
	  (GClassInitFunc) fo_table_row_class_init,
	  NULL,           /* class_finalize */
	  NULL,           /* class_data */
	  sizeof (FoTableRow),
	  0,              /* n_preallocs */
	...
	{
	  (GInterfaceInitFunc) fo_table_row_cbpbp_fo_init,	 /* interface_init */
	  NULL,
	  NULL
	};
	...
	{
	  (GInterfaceInitFunc) fo_table_row_table_border_fo_init, /* interface_init */
	  NULL,
	  NULL
	};
...
fo_table_row_class_init (FoTableRowClass *klass)
{
  ...
  object_class->finalize = fo_table_row_finalize;

  object_class->get_property = fo_table_row_get_property;
  object_class->set_property = fo_table_row_set_property;

  fofo_class->validate_content =
    fo_table_row_validate_content;
  fofo_class->validate2 =
    fo_table_row_validate;
  fofo_class->update_from_context = fo_table_row_update_from_context;
  fofo_class->debug_dump_properties = fo_table_row_debug_dump_properties;
  fofo_class->area_new2 =
    fo_table_row_area_new2;
...
/**
 * fo_table_row_cbpbp_fo_init:
 * @iface: #FoCBPBPFoIFace structure for this class.
 * 
 * Initialize #FoCBPBPFoIface interface for this class.
 **/
void
fo_table_row_cbpbp_fo_init (FoCBPBPFoIface *iface)
{
  iface->get_background_color = fo_table_row_get_background_color;
  iface->get_border_after_color = fo_table_row_get_border_after_color;
  iface->get_border_after_style = fo_table_row_get_border_after_style;
  iface->get_border_after_width = fo_table_row_get_border_after_width;
  iface->get_border_before_color = fo_table_row_get_border_before_color;
  iface->get_border_before_style = fo_table_row_get_border_before_style;
  iface->get_border_before_width = fo_table_row_get_border_before_width;
  iface->get_border_end_color = fo_table_row_get_border_end_color;
  iface->get_border_end_style = fo_table_row_get_border_end_style;
  iface->get_border_end_width = fo_table_row_get_border_end_width;
  iface->get_border_start_color = fo_table_row_get_border_start_color;
  iface->get_border_start_style = fo_table_row_get_border_start_style;
  iface->get_border_start_width = fo_table_row_get_border_start_width;
  iface->get_padding_after = fo_table_row_get_padding_after;
  iface->get_padding_before = fo_table_row_get_padding_before;
  iface->get_padding_end = fo_table_row_get_padding_end;
  iface->get_padding_start = fo_table_row_get_padding_start;
}

/**
 * fo_table_row_table_border_fo_init:
 * @iface: #FoTableBorderFoIFace structure for this class.
 * 
 * Initialize #FoTableBorderFoIface interface for this class.
 **/
void
fo_table_row_table_border_fo_init (FoTableBorderFoIface *iface)
{
  iface->get_background_color = fo_table_row_get_background_color;
  iface->get_border_after_color = fo_table_row_get_border_after_color;
  iface->get_border_after_precedence = fo_table_row_get_border_after_precedence;
  iface->get_border_after_style = fo_table_row_get_border_after_style;
  iface->get_border_after_width = fo_table_row_get_border_after_width;
  iface->get_border_before_color = fo_table_row_get_border_before_color;
  iface->get_border_before_precedence = fo_table_row_get_border_before_precedence;
  iface->get_border_before_style = fo_table_row_get_border_before_style;
  iface->get_border_before_width = fo_table_row_get_border_before_width;
  iface->get_border_end_color = fo_table_row_get_border_end_color;
  iface->get_border_end_precedence = fo_table_row_get_border_end_precedence;
  iface->get_border_end_style = fo_table_row_get_border_end_style;
  iface->get_border_end_width = fo_table_row_get_border_end_width;
  iface->get_border_start_color = fo_table_row_get_border_start_color;
  iface->get_border_start_precedence = fo_table_row_get_border_start_precedence;
  iface->get_border_start_style = fo_table_row_get_border_start_style;
  iface->get_border_start_width = fo_table_row_get_border_start_width;
}

/**
 * fo_table_row_finalize:
 * @object: #FoTableRow object to finalize.
 * 
 * Implements #GObjectFinalizeFunc for #FoTableRow.
 **/
void
fo_table_row_finalize (GObject *object)
{
  FoFo *fo = FO_FO (object);

  /* Release references to all property objects. */
  fo_table_row_set_background_color (fo, NULL);
  fo_table_row_set_background_image (fo, NULL);
  fo_table_row_set_block_progression_dimension (fo, NULL);
  fo_table_row_set_border_after_color (fo, NULL);
  fo_table_row_set_border_after_precedence (fo, NULL);
  fo_table_row_set_border_after_style (fo, NULL);
  fo_table_row_set_border_after_width (fo, NULL);
  fo_table_row_set_border_before_color (fo, NULL);
  fo_table_row_set_border_before_precedence (fo, NULL);
  fo_table_row_set_border_before_style (fo, NULL);
  fo_table_row_set_border_before_width (fo, NULL);
  fo_table_row_set_border_bottom_color (fo, NULL);
  fo_table_row_set_border_bottom_style (fo, NULL);
  fo_table_row_set_border_bottom_width (fo, NULL);
  fo_table_row_set_border_end_color (fo, NULL);
  fo_table_row_set_border_end_precedence (fo, NULL);
  fo_table_row_set_border_end_style (fo, NULL);
  fo_table_row_set_border_end_width (fo, NULL);
  fo_table_row_set_border_left_color (fo, NULL);
  fo_table_row_set_border_left_style (fo, NULL);
  fo_table_row_set_border_left_width (fo, NULL);
  fo_table_row_set_border_right_color (fo, NULL);
  fo_table_row_set_border_right_style (fo, NULL);
  fo_table_row_set_border_right_width (fo, NULL);
  fo_table_row_set_border_start_color (fo, NULL);
  fo_table_row_set_border_start_precedence (fo, NULL);
  fo_table_row_set_border_start_style (fo, NULL);
  fo_table_row_set_border_start_width (fo, NULL);
  fo_table_row_set_border_top_color (fo, NULL);
  fo_table_row_set_border_top_style (fo, NULL);
  fo_table_row_set_border_top_width (fo, NULL);
  fo_table_row_set_break_after (fo, NULL);
  fo_table_row_set_break_before (fo, NULL);
  fo_table_row_set_height (fo, NULL);
  fo_table_row_set_id (fo, NULL);
  fo_table_row_set_keep_together (fo, NULL);
  fo_table_row_set_keep_together_within_column (fo, NULL);
  fo_table_row_set_keep_together_within_line (fo, NULL);
  fo_table_row_set_keep_together_within_page (fo, NULL);
  fo_table_row_set_keep_with_next (fo, NULL);
  fo_table_row_set_keep_with_next_within_column (fo, NULL);
  fo_table_row_set_keep_with_next_within_line (fo, NULL);
  fo_table_row_set_keep_with_next_within_page (fo, NULL);
  fo_table_row_set_keep_with_previous (fo, NULL);
  fo_table_row_set_keep_with_previous_within_column (fo, NULL);
  fo_table_row_set_keep_with_previous_within_line (fo, NULL);
  fo_table_row_set_keep_with_previous_within_page (fo, NULL);
  fo_table_row_set_padding_after (fo, NULL);
  fo_table_row_set_padding_before (fo, NULL);
  fo_table_row_set_padding_bottom (fo, NULL);
  fo_table_row_set_padding_end (fo, NULL);
  fo_table_row_set_padding_left (fo, NULL);
  fo_table_row_set_padding_right (fo, NULL);
  fo_table_row_set_padding_start (fo, NULL);
  fo_table_row_set_padding_top (fo, NULL);
  fo_table_row_set_role (fo, NULL);
  fo_table_row_set_source_document (fo, NULL);

  G_OBJECT_CLASS (parent_class)->finalize (object);
}

/**
 * fo_table_row_get_property:
 * @object:  #GObject whose property will be retrieved.
 * @prop_id: Property ID assigned when property registered.
 * @value:   GValue to set with property value.
 * @pspec:   Parameter specification for this property type.
 * 
 * Implements #GObjectGetPropertyFunc for #FoTableRow.
 **/
void
fo_table_row_get_property (GObject    *object,
                           guint       prop_id,
                           GValue     *value,
                           GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_BACKGROUND_COLOR:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_background_color (fo_fo)));
      break;
    case PROP_BACKGROUND_IMAGE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_background_image (fo_fo)));
      break;
    case PROP_BLOCK_PROGRESSION_DIMENSION:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_block_progression_dimension (fo_fo)));
      break;
    case PROP_BORDER_AFTER_COLOR:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_after_color (fo_fo)));
      break;
    case PROP_BORDER_AFTER_PRECEDENCE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_after_precedence (fo_fo)));
      break;
    case PROP_BORDER_AFTER_STYLE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_after_style (fo_fo)));
      break;
    case PROP_BORDER_AFTER_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_after_width (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_COLOR:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_before_color (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_PRECEDENCE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_before_precedence (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_STYLE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_before_style (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_before_width (fo_fo)));
      break;
    case PROP_BORDER_BOTTOM_COLOR:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_bottom_color (fo_fo)));
      break;
    case PROP_BORDER_BOTTOM_STYLE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_bottom_style (fo_fo)));
      break;
    case PROP_BORDER_BOTTOM_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_bottom_width (fo_fo)));
      break;
    case PROP_BORDER_END_COLOR:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_end_color (fo_fo)));
      break;
    case PROP_BORDER_END_PRECEDENCE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_end_precedence (fo_fo)));
      break;
    case PROP_BORDER_END_STYLE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_end_style (fo_fo)));
      break;
    case PROP_BORDER_END_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_end_width (fo_fo)));
      break;
    case PROP_BORDER_LEFT_COLOR:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_left_color (fo_fo)));
      break;
    case PROP_BORDER_LEFT_STYLE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_left_style (fo_fo)));
      break;
    case PROP_BORDER_LEFT_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_left_width (fo_fo)));
      break;
    case PROP_BORDER_RIGHT_COLOR:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_right_color (fo_fo)));
      break;
    case PROP_BORDER_RIGHT_STYLE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_right_style (fo_fo)));
      break;
    case PROP_BORDER_RIGHT_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_right_width (fo_fo)));
      break;
    case PROP_BORDER_START_COLOR:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_start_color (fo_fo)));
      break;
    case PROP_BORDER_START_PRECEDENCE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_start_precedence (fo_fo)));
      break;
    case PROP_BORDER_START_STYLE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_start_style (fo_fo)));
      break;
    case PROP_BORDER_START_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_start_width (fo_fo)));
      break;
    case PROP_BORDER_TOP_COLOR:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_top_color (fo_fo)));
      break;
    case PROP_BORDER_TOP_STYLE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_top_style (fo_fo)));
      break;
    case PROP_BORDER_TOP_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_border_top_width (fo_fo)));
      break;
    case PROP_BREAK_AFTER:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_break_after (fo_fo)));
      break;
    case PROP_BREAK_BEFORE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_break_before (fo_fo)));
      break;
    case PROP_HEIGHT:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_height (fo_fo)));
      break;
    case PROP_ID:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_id (fo_fo)));
      break;
    case PROP_KEEP_TOGETHER:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_together (fo_fo)));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_COLUMN:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_together_within_column (fo_fo)));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_LINE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_together_within_line (fo_fo)));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_PAGE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_together_within_page (fo_fo)));
      break;
    case PROP_KEEP_WITH_NEXT:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_with_next (fo_fo)));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_COLUMN:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_with_next_within_column (fo_fo)));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_LINE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_with_next_within_line (fo_fo)));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_PAGE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_with_next_within_page (fo_fo)));
      break;
    case PROP_KEEP_WITH_PREVIOUS:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_with_previous (fo_fo)));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_COLUMN:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_with_previous_within_column (fo_fo)));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_LINE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_with_previous_within_line (fo_fo)));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_PAGE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_keep_with_previous_within_page (fo_fo)));
      break;
    case PROP_PADDING_AFTER:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_padding_after (fo_fo)));
      break;
    case PROP_PADDING_BEFORE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_padding_before (fo_fo)));
      break;
    case PROP_PADDING_BOTTOM:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_padding_bottom (fo_fo)));
      break;
    case PROP_PADDING_END:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_padding_end (fo_fo)));
      break;
    case PROP_PADDING_LEFT:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_padding_left (fo_fo)));
      break;
    case PROP_PADDING_RIGHT:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_padding_right (fo_fo)));
      break;
    case PROP_PADDING_START:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_padding_start (fo_fo)));
      break;
    case PROP_PADDING_TOP:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_padding_top (fo_fo)));
      break;
    case PROP_ROLE:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_role (fo_fo)));
      break;
    case PROP_SOURCE_DOCUMENT:
      g_value_set_object (value, G_OBJECT (fo_table_row_get_source_document (fo_fo)));
      break;
    default:
...
/**
 * fo_table_row_set_property:
 * @object:  #GObject whose property will be set.
 * @prop_id: Property ID assigned when property registered.
 * @value:   New value for property.
 * @pspec:   Parameter specification for this property type.
 * 
 * Implements #GObjectSetPropertyFunc for #FoTableRow.
 **/
void
fo_table_row_set_property (GObject      *object,
                           guint         prop_id,
                           const GValue *value,
                           GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_BACKGROUND_COLOR:
      fo_table_row_set_background_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BACKGROUND_IMAGE:
      fo_table_row_set_background_image (fo_fo, g_value_get_object (value));
      break;
    case PROP_BLOCK_PROGRESSION_DIMENSION:
      fo_table_row_set_block_progression_dimension (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_COLOR:
      fo_table_row_set_border_after_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_PRECEDENCE:
      fo_table_row_set_border_after_precedence (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_STYLE:
      fo_table_row_set_border_after_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_WIDTH:
      fo_table_row_set_border_after_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_COLOR:
      fo_table_row_set_border_before_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_PRECEDENCE:
      fo_table_row_set_border_before_precedence (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_STYLE:
      fo_table_row_set_border_before_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_WIDTH:
      fo_table_row_set_border_before_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BOTTOM_COLOR:
      fo_table_row_set_border_bottom_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BOTTOM_STYLE:
      fo_table_row_set_border_bottom_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BOTTOM_WIDTH:
      fo_table_row_set_border_bottom_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_COLOR:
      fo_table_row_set_border_end_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_PRECEDENCE:
      fo_table_row_set_border_end_precedence (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_STYLE:
      fo_table_row_set_border_end_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_WIDTH:
      fo_table_row_set_border_end_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_LEFT_COLOR:
      fo_table_row_set_border_left_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_LEFT_STYLE:
      fo_table_row_set_border_left_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_LEFT_WIDTH:
      fo_table_row_set_border_left_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_RIGHT_COLOR:
      fo_table_row_set_border_right_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_RIGHT_STYLE:
      fo_table_row_set_border_right_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_RIGHT_WIDTH:
      fo_table_row_set_border_right_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_COLOR:
      fo_table_row_set_border_start_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_PRECEDENCE:
      fo_table_row_set_border_start_precedence (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_STYLE:
      fo_table_row_set_border_start_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_WIDTH:
      fo_table_row_set_border_start_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_TOP_COLOR:
      fo_table_row_set_border_top_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_TOP_STYLE:
      fo_table_row_set_border_top_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_TOP_WIDTH:
      fo_table_row_set_border_top_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BREAK_AFTER:
      fo_table_row_set_break_after (fo_fo, g_value_get_object (value));
      break;
    case PROP_BREAK_BEFORE:
      fo_table_row_set_break_before (fo_fo, g_value_get_object (value));
      break;
    case PROP_HEIGHT:
      fo_table_row_set_height (fo_fo, g_value_get_object (value));
      break;
    case PROP_ID:
      fo_table_row_set_id (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_TOGETHER:
      fo_table_row_set_keep_together (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_COLUMN:
      fo_table_row_set_keep_together_within_column (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_LINE:
      fo_table_row_set_keep_together_within_line (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_PAGE:
      fo_table_row_set_keep_together_within_page (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_NEXT:
      fo_table_row_set_keep_with_next (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_COLUMN:
      fo_table_row_set_keep_with_next_within_column (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_LINE:
      fo_table_row_set_keep_with_next_within_line (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_PAGE:
      fo_table_row_set_keep_with_next_within_page (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_PREVIOUS:
      fo_table_row_set_keep_with_previous (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_COLUMN:
      fo_table_row_set_keep_with_previous_within_column (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_LINE:
      fo_table_row_set_keep_with_previous_within_line (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_PAGE:
      fo_table_row_set_keep_with_previous_within_page (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_AFTER:
      fo_table_row_set_padding_after (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_BEFORE:
      fo_table_row_set_padding_before (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_BOTTOM:
      fo_table_row_set_padding_bottom (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_END:
      fo_table_row_set_padding_end (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_LEFT:
      fo_table_row_set_padding_left (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_RIGHT:
      fo_table_row_set_padding_right (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_START:
      fo_table_row_set_padding_start (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_TOP:
      fo_table_row_set_padding_top (fo_fo, g_value_get_object (value));
      break;
    case PROP_ROLE:
      fo_table_row_set_role (fo_fo, g_value_get_object (value));
      break;
    case PROP_SOURCE_DOCUMENT:
      fo_table_row_set_source_document (fo_fo, g_value_get_object (value));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
 ...
 * 
 * Return value: the new #FoTableRow.
 **/
FoFo*
fo_table_row_new (void)
{
  return FO_FO (g_object_new (fo_table_row_get_type (),
                              NULL));
}

/**
 * fo_table_row_validate_content:
 * @fo:    #FoTableRow object to validate.
 ...
 **/
gboolean
fo_table_row_validate_content (FoFo    *fo,
                               GError **error)
{
  FoNode *child_node;
  GError *tmp_error;
  ...
  g_return_val_if_fail (FO_IS_TABLE_ROW (fo), TRUE);
  ...
  while (child_node)
    {
      ...
      if (FO_IS_TABLE_CELL (child_node))
	{
 ...
 **/
void
fo_table_row_validate (FoFo      *fo,
                       FoContext *current_context,
                       FoContext *parent_context,
                       GError   **error)
{
  g_return_if_fail (fo != NULL);
  g_return_if_fail (FO_IS_TABLE_ROW (fo));
...
/**
 * fo_table_row_update_from_context:
 * @fo:      The #FoFo object.
 ...
 **/
void
fo_table_row_update_from_context (FoFo      *fo,
                                  FoContext *context)
{
  g_return_if_fail (fo != NULL);
  g_return_if_fail (FO_IS_TABLE_ROW (fo));
 ...
 **/
void
fo_table_row_debug_dump_properties (FoFo *fo,
                                    gint  depth)
{
  FoTableRow *fo_table_row;

  g_return_if_fail (fo != NULL);
  g_return_if_fail (FO_IS_TABLE_ROW (fo));

  fo_table_row = FO_TABLE_ROW (fo);

  fo_object_debug_dump (fo_table_row->background_color, depth);
  fo_object_debug_dump (fo_table_row->background_image, depth);
  fo_object_debug_dump (fo_table_row->block_progression_dimension, depth);
  fo_object_debug_dump (fo_table_row->border_after_color, depth);
  fo_object_debug_dump (fo_table_row->border_after_precedence, depth);
  fo_object_debug_dump (fo_table_row->border_after_style, depth);
  fo_object_debug_dump (fo_table_row->border_after_width, depth);
  fo_object_debug_dump (fo_table_row->border_before_color, depth);
  fo_object_debug_dump (fo_table_row->border_before_precedence, depth);
  fo_object_debug_dump (fo_table_row->border_before_style, depth);
  fo_object_debug_dump (fo_table_row->border_before_width, depth);
  fo_object_debug_dump (fo_table_row->border_bottom_color, depth);
  fo_object_debug_dump (fo_table_row->border_bottom_style, depth);
  fo_object_debug_dump (fo_table_row->border_bottom_width, depth);
  fo_object_debug_dump (fo_table_row->border_end_color, depth);
  fo_object_debug_dump (fo_table_row->border_end_precedence, depth);
  fo_object_debug_dump (fo_table_row->border_end_style, depth);
  fo_object_debug_dump (fo_table_row->border_end_width, depth);
  fo_object_debug_dump (fo_table_row->border_left_color, depth);
  fo_object_debug_dump (fo_table_row->border_left_style, depth);
  fo_object_debug_dump (fo_table_row->border_left_width, depth);
  fo_object_debug_dump (fo_table_row->border_right_color, depth);
  fo_object_debug_dump (fo_table_row->border_right_style, depth);
  fo_object_debug_dump (fo_table_row->border_right_width, depth);
  fo_object_debug_dump (fo_table_row->border_start_color, depth);
  fo_object_debug_dump (fo_table_row->border_start_precedence, depth);
  fo_object_debug_dump (fo_table_row->border_start_style, depth);
  fo_object_debug_dump (fo_table_row->border_start_width, depth);
  fo_object_debug_dump (fo_table_row->border_top_color, depth);
  fo_object_debug_dump (fo_table_row->border_top_style, depth);
  fo_object_debug_dump (fo_table_row->border_top_width, depth);
  fo_object_debug_dump (fo_table_row->break_after, depth);
  fo_object_debug_dump (fo_table_row->break_before, depth);
  fo_object_debug_dump (fo_table_row->height, depth);
  fo_object_debug_dump (fo_table_row->id, depth);
  fo_object_debug_dump (fo_table_row->keep_together, depth);
  fo_object_debug_dump (fo_table_row->keep_together_within_column, depth);
  fo_object_debug_dump (fo_table_row->keep_together_within_line, depth);
  fo_object_debug_dump (fo_table_row->keep_together_within_page, depth);
  fo_object_debug_dump (fo_table_row->keep_with_next, depth);
  fo_object_debug_dump (fo_table_row->keep_with_next_within_column, depth);
  fo_object_debug_dump (fo_table_row->keep_with_next_within_line, depth);
  fo_object_debug_dump (fo_table_row->keep_with_next_within_page, depth);
  fo_object_debug_dump (fo_table_row->keep_with_previous, depth);
  fo_object_debug_dump (fo_table_row->keep_with_previous_within_column, depth);
  fo_object_debug_dump (fo_table_row->keep_with_previous_within_line, depth);
  fo_object_debug_dump (fo_table_row->keep_with_previous_within_page, depth);
  fo_object_debug_dump (fo_table_row->padding_after, depth);
  fo_object_debug_dump (fo_table_row->padding_before, depth);
  fo_object_debug_dump (fo_table_row->padding_bottom, depth);
  fo_object_debug_dump (fo_table_row->padding_end, depth);
  fo_object_debug_dump (fo_table_row->padding_left, depth);
  fo_object_debug_dump (fo_table_row->padding_right, depth);
  fo_object_debug_dump (fo_table_row->padding_start, depth);
  fo_object_debug_dump (fo_table_row->padding_top, depth);
  fo_object_debug_dump (fo_table_row->role, depth);
  fo_object_debug_dump (fo_table_row->source_document, depth);
...
**/
FoProperty *
fo_table_row_get_background_color (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;

  g_return_val_if_fail (fo_table_row != NULL, NULL);
  g_return_val_if_fail (FO_IS_TABLE_ROW (fo_table_row), NULL);

  return fo_table_row->background_color;
}
 ...
 **/
void
fo_table_row_set_background_color (FoFo *fo_fo,
		         FoProperty *new_background_color)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;

  g_return_if_fail (fo_table_row != NULL);
  g_return_if_fail (FO_IS_TABLE_ROW (fo_table_row));
  ...
  if (fo_table_row->background_color != NULL)
    {
      g_object_unref (fo_table_row->background_color);
    }
  fo_table_row->background_color = new_background_color;
  /*g_object_notify (G_OBJECT (fo_table_row), "background-color");*/
}
...
**/
FoProperty *
fo_table_row_get_background_image (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->background_image;
}
 ...
 **/
void
fo_table_row_set_background_image (FoFo *fo_fo,
		         FoProperty *new_background_image)
{
  ...
  if (fo_table_row->background_image != NULL)
    {
      g_object_unref (fo_table_row->background_image);
    }
  fo_table_row->background_image = new_background_image;
  /*g_object_notify (G_OBJECT (fo_table_row), "background-image");*/
}
...
**/
FoProperty *
fo_table_row_get_block_progression_dimension (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->block_progression_dimension;
}
 ...
 **/
void
fo_table_row_set_block_progression_dimension (FoFo *fo_fo,
		         FoProperty *new_block_progression_dimension)
{
  ...
  if (fo_table_row->block_progression_dimension != NULL)
    {
      g_object_unref (fo_table_row->block_progression_dimension);
    }
  fo_table_row->block_progression_dimension = new_block_progression_dimension;
  /*g_object_notify (G_OBJECT (fo_table_row), "block-progression-dimension");*/
}
...
**/
FoProperty *
fo_table_row_get_border_after_color (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_after_color;
}
 ...
 **/
void
fo_table_row_set_border_after_color (FoFo *fo_fo,
		         FoProperty *new_border_after_color)
{
  ...
  if (fo_table_row->border_after_color != NULL)
    {
      g_object_unref (fo_table_row->border_after_color);
    }
  fo_table_row->border_after_color = new_border_after_color;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-after-color");*/
}
...
**/
FoProperty *
fo_table_row_get_border_after_precedence (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_after_precedence;
}
 ...
 **/
void
fo_table_row_set_border_after_precedence (FoFo *fo_fo,
		         FoProperty *new_border_after_precedence)
{
  ...
  if (fo_table_row->border_after_precedence != NULL)
    {
      g_object_unref (fo_table_row->border_after_precedence);
    }
  fo_table_row->border_after_precedence = new_border_after_precedence;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-after-precedence");*/
}
...
**/
FoProperty *
fo_table_row_get_border_after_style (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_after_style;
}
 ...
 **/
void
fo_table_row_set_border_after_style (FoFo *fo_fo,
		         FoProperty *new_border_after_style)
{
  ...
  if (fo_table_row->border_after_style != NULL)
    {
      g_object_unref (fo_table_row->border_after_style);
    }
  fo_table_row->border_after_style = new_border_after_style;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-after-style");*/
}
...
**/
FoProperty *
fo_table_row_get_border_after_width (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_after_width;
}
 ...
 **/
void
fo_table_row_set_border_after_width (FoFo *fo_fo,
		         FoProperty *new_border_after_width)
{
  ...
  if (fo_table_row->border_after_width != NULL)
    {
      g_object_unref (fo_table_row->border_after_width);
    }
  fo_table_row->border_after_width = new_border_after_width;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-after-width");*/
}
...
**/
FoProperty *
fo_table_row_get_border_before_color (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_before_color;
}
 ...
 **/
void
fo_table_row_set_border_before_color (FoFo *fo_fo,
		         FoProperty *new_border_before_color)
{
  ...
  if (fo_table_row->border_before_color != NULL)
    {
      g_object_unref (fo_table_row->border_before_color);
    }
  fo_table_row->border_before_color = new_border_before_color;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-before-color");*/
}
...
**/
FoProperty *
fo_table_row_get_border_before_precedence (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_before_precedence;
}
 ...
 **/
void
fo_table_row_set_border_before_precedence (FoFo *fo_fo,
		         FoProperty *new_border_before_precedence)
{
  ...
  if (fo_table_row->border_before_precedence != NULL)
    {
      g_object_unref (fo_table_row->border_before_precedence);
    }
  fo_table_row->border_before_precedence = new_border_before_precedence;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-before-precedence");*/
}
...
**/
FoProperty *
fo_table_row_get_border_before_style (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_before_style;
}
 ...
 **/
void
fo_table_row_set_border_before_style (FoFo *fo_fo,
		         FoProperty *new_border_before_style)
{
  ...
  if (fo_table_row->border_before_style != NULL)
    {
      g_object_unref (fo_table_row->border_before_style);
    }
  fo_table_row->border_before_style = new_border_before_style;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-before-style");*/
}
...
**/
FoProperty *
fo_table_row_get_border_before_width (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_before_width;
}
 ...
 **/
void
fo_table_row_set_border_before_width (FoFo *fo_fo,
		         FoProperty *new_border_before_width)
{
  ...
  if (fo_table_row->border_before_width != NULL)
    {
      g_object_unref (fo_table_row->border_before_width);
    }
  fo_table_row->border_before_width = new_border_before_width;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-before-width");*/
}
...
**/
FoProperty *
fo_table_row_get_border_bottom_color (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_bottom_color;
}
 ...
 **/
void
fo_table_row_set_border_bottom_color (FoFo *fo_fo,
		         FoProperty *new_border_bottom_color)
{
  ...
  if (fo_table_row->border_bottom_color != NULL)
    {
      g_object_unref (fo_table_row->border_bottom_color);
    }
  fo_table_row->border_bottom_color = new_border_bottom_color;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-bottom-color");*/
}
...
**/
FoProperty *
fo_table_row_get_border_bottom_style (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_bottom_style;
}
 ...
 **/
void
fo_table_row_set_border_bottom_style (FoFo *fo_fo,
		         FoProperty *new_border_bottom_style)
{
  ...
  if (fo_table_row->border_bottom_style != NULL)
    {
      g_object_unref (fo_table_row->border_bottom_style);
    }
  fo_table_row->border_bottom_style = new_border_bottom_style;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-bottom-style");*/
}
...
**/
FoProperty *
fo_table_row_get_border_bottom_width (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_bottom_width;
}
 ...
 **/
void
fo_table_row_set_border_bottom_width (FoFo *fo_fo,
		         FoProperty *new_border_bottom_width)
{
  ...
  if (fo_table_row->border_bottom_width != NULL)
    {
      g_object_unref (fo_table_row->border_bottom_width);
    }
  fo_table_row->border_bottom_width = new_border_bottom_width;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-bottom-width");*/
}
...
**/
FoProperty *
fo_table_row_get_border_end_color (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_end_color;
}
 ...
 **/
void
fo_table_row_set_border_end_color (FoFo *fo_fo,
		         FoProperty *new_border_end_color)
{
  ...
  if (fo_table_row->border_end_color != NULL)
    {
      g_object_unref (fo_table_row->border_end_color);
    }
  fo_table_row->border_end_color = new_border_end_color;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-end-color");*/
}
...
**/
FoProperty *
fo_table_row_get_border_end_precedence (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_end_precedence;
}
 ...
 **/
void
fo_table_row_set_border_end_precedence (FoFo *fo_fo,
		         FoProperty *new_border_end_precedence)
{
  ...
  if (fo_table_row->border_end_precedence != NULL)
    {
      g_object_unref (fo_table_row->border_end_precedence);
    }
  fo_table_row->border_end_precedence = new_border_end_precedence;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-end-precedence");*/
}
...
**/
FoProperty *
fo_table_row_get_border_end_style (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_end_style;
}
 ...
 **/
void
fo_table_row_set_border_end_style (FoFo *fo_fo,
		         FoProperty *new_border_end_style)
{
  ...
  if (fo_table_row->border_end_style != NULL)
    {
      g_object_unref (fo_table_row->border_end_style);
    }
  fo_table_row->border_end_style = new_border_end_style;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-end-style");*/
}
...
**/
FoProperty *
fo_table_row_get_border_end_width (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_end_width;
}
 ...
 **/
void
fo_table_row_set_border_end_width (FoFo *fo_fo,
		         FoProperty *new_border_end_width)
{
  ...
  if (fo_table_row->border_end_width != NULL)
    {
      g_object_unref (fo_table_row->border_end_width);
    }
  fo_table_row->border_end_width = new_border_end_width;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-end-width");*/
}
...
**/
FoProperty *
fo_table_row_get_border_left_color (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_left_color;
}
 ...
 **/
void
fo_table_row_set_border_left_color (FoFo *fo_fo,
		         FoProperty *new_border_left_color)
{
  ...
  if (fo_table_row->border_left_color != NULL)
    {
      g_object_unref (fo_table_row->border_left_color);
    }
  fo_table_row->border_left_color = new_border_left_color;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-left-color");*/
}
...
**/
FoProperty *
fo_table_row_get_border_left_style (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_left_style;
}
 ...
 **/
void
fo_table_row_set_border_left_style (FoFo *fo_fo,
		         FoProperty *new_border_left_style)
{
  ...
  if (fo_table_row->border_left_style != NULL)
    {
      g_object_unref (fo_table_row->border_left_style);
    }
  fo_table_row->border_left_style = new_border_left_style;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-left-style");*/
}
...
**/
FoProperty *
fo_table_row_get_border_left_width (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_left_width;
}
 ...
 **/
void
fo_table_row_set_border_left_width (FoFo *fo_fo,
		         FoProperty *new_border_left_width)
{
  ...
  if (fo_table_row->border_left_width != NULL)
    {
      g_object_unref (fo_table_row->border_left_width);
    }
  fo_table_row->border_left_width = new_border_left_width;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-left-width");*/
}
...
**/
FoProperty *
fo_table_row_get_border_right_color (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_right_color;
}
 ...
 **/
void
fo_table_row_set_border_right_color (FoFo *fo_fo,
		         FoProperty *new_border_right_color)
{
  ...
  if (fo_table_row->border_right_color != NULL)
    {
      g_object_unref (fo_table_row->border_right_color);
    }
  fo_table_row->border_right_color = new_border_right_color;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-right-color");*/
}
...
**/
FoProperty *
fo_table_row_get_border_right_style (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_right_style;
}
 ...
 **/
void
fo_table_row_set_border_right_style (FoFo *fo_fo,
		         FoProperty *new_border_right_style)
{
  ...
  if (fo_table_row->border_right_style != NULL)
    {
      g_object_unref (fo_table_row->border_right_style);
    }
  fo_table_row->border_right_style = new_border_right_style;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-right-style");*/
}
...
**/
FoProperty *
fo_table_row_get_border_right_width (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_right_width;
}
 ...
 **/
void
fo_table_row_set_border_right_width (FoFo *fo_fo,
		         FoProperty *new_border_right_width)
{
  ...
  if (fo_table_row->border_right_width != NULL)
    {
      g_object_unref (fo_table_row->border_right_width);
    }
  fo_table_row->border_right_width = new_border_right_width;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-right-width");*/
}
...
**/
FoProperty *
fo_table_row_get_border_start_color (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_start_color;
}
 ...
 **/
void
fo_table_row_set_border_start_color (FoFo *fo_fo,
		         FoProperty *new_border_start_color)
{
  ...
  if (fo_table_row->border_start_color != NULL)
    {
      g_object_unref (fo_table_row->border_start_color);
    }
  fo_table_row->border_start_color = new_border_start_color;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-start-color");*/
}
...
**/
FoProperty *
fo_table_row_get_border_start_precedence (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_start_precedence;
}
 ...
 **/
void
fo_table_row_set_border_start_precedence (FoFo *fo_fo,
		         FoProperty *new_border_start_precedence)
{
  ...
  if (fo_table_row->border_start_precedence != NULL)
    {
      g_object_unref (fo_table_row->border_start_precedence);
    }
  fo_table_row->border_start_precedence = new_border_start_precedence;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-start-precedence");*/
}
...
**/
FoProperty *
fo_table_row_get_border_start_style (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_start_style;
}
 ...
 **/
void
fo_table_row_set_border_start_style (FoFo *fo_fo,
		         FoProperty *new_border_start_style)
{
  ...
  if (fo_table_row->border_start_style != NULL)
    {
      g_object_unref (fo_table_row->border_start_style);
    }
  fo_table_row->border_start_style = new_border_start_style;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-start-style");*/
}
...
**/
FoProperty *
fo_table_row_get_border_start_width (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_start_width;
}
 ...
 **/
void
fo_table_row_set_border_start_width (FoFo *fo_fo,
		         FoProperty *new_border_start_width)
{
  ...
  if (fo_table_row->border_start_width != NULL)
    {
      g_object_unref (fo_table_row->border_start_width);
    }
  fo_table_row->border_start_width = new_border_start_width;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-start-width");*/
}
...
**/
FoProperty *
fo_table_row_get_border_top_color (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_top_color;
}
 ...
 **/
void
fo_table_row_set_border_top_color (FoFo *fo_fo,
		         FoProperty *new_border_top_color)
{
  ...
  if (fo_table_row->border_top_color != NULL)
    {
      g_object_unref (fo_table_row->border_top_color);
    }
  fo_table_row->border_top_color = new_border_top_color;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-top-color");*/
}
...
**/
FoProperty *
fo_table_row_get_border_top_style (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_top_style;
}
 ...
 **/
void
fo_table_row_set_border_top_style (FoFo *fo_fo,
		         FoProperty *new_border_top_style)
{
  ...
  if (fo_table_row->border_top_style != NULL)
    {
      g_object_unref (fo_table_row->border_top_style);
    }
  fo_table_row->border_top_style = new_border_top_style;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-top-style");*/
}
...
**/
FoProperty *
fo_table_row_get_border_top_width (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->border_top_width;
}
 ...
 **/
void
fo_table_row_set_border_top_width (FoFo *fo_fo,
		         FoProperty *new_border_top_width)
{
  ...
  if (fo_table_row->border_top_width != NULL)
    {
      g_object_unref (fo_table_row->border_top_width);
    }
  fo_table_row->border_top_width = new_border_top_width;
  /*g_object_notify (G_OBJECT (fo_table_row), "border-top-width");*/
}
...
**/
FoProperty *
fo_table_row_get_break_after (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->break_after;
}
 ...
 **/
void
fo_table_row_set_break_after (FoFo *fo_fo,
		         FoProperty *new_break_after)
{
  ...
  if (fo_table_row->break_after != NULL)
    {
      g_object_unref (fo_table_row->break_after);
    }
  fo_table_row->break_after = new_break_after;
  /*g_object_notify (G_OBJECT (fo_table_row), "break-after");*/
}
...
**/
FoProperty *
fo_table_row_get_break_before (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->break_before;
}
 ...
 **/
void
fo_table_row_set_break_before (FoFo *fo_fo,
		         FoProperty *new_break_before)
{
  ...
  if (fo_table_row->break_before != NULL)
    {
      g_object_unref (fo_table_row->break_before);
    }
  fo_table_row->break_before = new_break_before;
  /*g_object_notify (G_OBJECT (fo_table_row), "break-before");*/
}
...
**/
FoProperty *
fo_table_row_get_height (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
 ...
 **/
void
fo_table_row_set_height (FoFo *fo_fo,
		         FoProperty *new_height)
{
  ...
  if (fo_table_row->height != NULL)
    {
      g_object_unref (fo_table_row->height);
    }
  fo_table_row->height = new_height;
  /*g_object_notify (G_OBJECT (fo_table_row), "height");*/
}
...
**/
FoProperty *
fo_table_row_get_id (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
 ...
 **/
void
fo_table_row_set_id (FoFo *fo_fo,
		         FoProperty *new_id)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  if (fo_table_row->id != NULL)
    {
      g_object_unref (fo_table_row->id);
    }
  fo_table_row->id = new_id;
  /*g_object_notify (G_OBJECT (fo_table_row), "id");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_together (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_together;
}
 ...
 **/
void
fo_table_row_set_keep_together (FoFo *fo_fo,
		         FoProperty *new_keep_together)
{
  ...
  if (fo_table_row->keep_together != NULL)
    {
      g_object_unref (fo_table_row->keep_together);
    }
  fo_table_row->keep_together = new_keep_together;
...
**/
FoProperty *
fo_table_row_get_keep_together_within_column (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_together_within_column;
}
 ...
 **/
void
fo_table_row_set_keep_together_within_column (FoFo *fo_fo,
		         FoProperty *new_keep_together_within_column)
{
  ...
  if (fo_table_row->keep_together_within_column != NULL)
    {
      g_object_unref (fo_table_row->keep_together_within_column);
    }
  fo_table_row->keep_together_within_column = new_keep_together_within_column;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-together-within-column");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_together_within_line (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_together_within_line;
}
 ...
 **/
void
fo_table_row_set_keep_together_within_line (FoFo *fo_fo,
		         FoProperty *new_keep_together_within_line)
{
  ...
  if (fo_table_row->keep_together_within_line != NULL)
    {
      g_object_unref (fo_table_row->keep_together_within_line);
    }
  fo_table_row->keep_together_within_line = new_keep_together_within_line;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-together-within-line");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_together_within_page (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_together_within_page;
}
 ...
 **/
void
fo_table_row_set_keep_together_within_page (FoFo *fo_fo,
		         FoProperty *new_keep_together_within_page)
{
  ...
  if (fo_table_row->keep_together_within_page != NULL)
    {
      g_object_unref (fo_table_row->keep_together_within_page);
    }
  fo_table_row->keep_together_within_page = new_keep_together_within_page;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-together-within-page");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_with_next (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_with_next;
}
 ...
 **/
void
fo_table_row_set_keep_with_next (FoFo *fo_fo,
		         FoProperty *new_keep_with_next)
{
  ...
  if (fo_table_row->keep_with_next != NULL)
    {
      g_object_unref (fo_table_row->keep_with_next);
    }
  fo_table_row->keep_with_next = new_keep_with_next;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-with-next");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_with_next_within_column (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_with_next_within_column;
}
 ...
 **/
void
fo_table_row_set_keep_with_next_within_column (FoFo *fo_fo,
		         FoProperty *new_keep_with_next_within_column)
{
  ...
  if (fo_table_row->keep_with_next_within_column != NULL)
    {
      g_object_unref (fo_table_row->keep_with_next_within_column);
    }
  fo_table_row->keep_with_next_within_column = new_keep_with_next_within_column;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-with-next-within-column");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_with_next_within_line (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_with_next_within_line;
}
 ...
 **/
void
fo_table_row_set_keep_with_next_within_line (FoFo *fo_fo,
		         FoProperty *new_keep_with_next_within_line)
{
  ...
  if (fo_table_row->keep_with_next_within_line != NULL)
    {
      g_object_unref (fo_table_row->keep_with_next_within_line);
    }
  fo_table_row->keep_with_next_within_line = new_keep_with_next_within_line;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-with-next-within-line");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_with_next_within_page (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_with_next_within_page;
}
 ...
 **/
void
fo_table_row_set_keep_with_next_within_page (FoFo *fo_fo,
		         FoProperty *new_keep_with_next_within_page)
{
  ...
  if (fo_table_row->keep_with_next_within_page != NULL)
    {
      g_object_unref (fo_table_row->keep_with_next_within_page);
    }
  fo_table_row->keep_with_next_within_page = new_keep_with_next_within_page;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-with-next-within-page");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_with_previous (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_with_previous;
}
 ...
 **/
void
fo_table_row_set_keep_with_previous (FoFo *fo_fo,
		         FoProperty *new_keep_with_previous)
{
  ...
  if (fo_table_row->keep_with_previous != NULL)
    {
      g_object_unref (fo_table_row->keep_with_previous);
    }
  fo_table_row->keep_with_previous = new_keep_with_previous;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-with-previous");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_with_previous_within_column (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_with_previous_within_column;
}
 ...
 **/
void
fo_table_row_set_keep_with_previous_within_column (FoFo *fo_fo,
		         FoProperty *new_keep_with_previous_within_column)
{
  ...
  if (fo_table_row->keep_with_previous_within_column != NULL)
    {
      g_object_unref (fo_table_row->keep_with_previous_within_column);
    }
  fo_table_row->keep_with_previous_within_column = new_keep_with_previous_within_column;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-with-previous-within-column");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_with_previous_within_line (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_with_previous_within_line;
}
 ...
 **/
void
fo_table_row_set_keep_with_previous_within_line (FoFo *fo_fo,
		         FoProperty *new_keep_with_previous_within_line)
{
  ...
  if (fo_table_row->keep_with_previous_within_line != NULL)
    {
      g_object_unref (fo_table_row->keep_with_previous_within_line);
    }
  fo_table_row->keep_with_previous_within_line = new_keep_with_previous_within_line;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-with-previous-within-line");*/
}
...
**/
FoProperty *
fo_table_row_get_keep_with_previous_within_page (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->keep_with_previous_within_page;
}
 ...
 **/
void
fo_table_row_set_keep_with_previous_within_page (FoFo *fo_fo,
		         FoProperty *new_keep_with_previous_within_page)
{
  ...
  if (fo_table_row->keep_with_previous_within_page != NULL)
    {
      g_object_unref (fo_table_row->keep_with_previous_within_page);
    }
  fo_table_row->keep_with_previous_within_page = new_keep_with_previous_within_page;
  /*g_object_notify (G_OBJECT (fo_table_row), "keep-with-previous-within-page");*/
}
...
**/
FoProperty *
fo_table_row_get_padding_after (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->padding_after;
}
 ...
 **/
void
fo_table_row_set_padding_after (FoFo *fo_fo,
		         FoProperty *new_padding_after)
{
  ...
  if (fo_table_row->padding_after != NULL)
    {
      g_object_unref (fo_table_row->padding_after);
    }
  fo_table_row->padding_after = new_padding_after;
  /*g_object_notify (G_OBJECT (fo_table_row), "padding-after");*/
}
...
**/
FoProperty *
fo_table_row_get_padding_before (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->padding_before;
}
 ...
 **/
void
fo_table_row_set_padding_before (FoFo *fo_fo,
		         FoProperty *new_padding_before)
{
  ...
  if (fo_table_row->padding_before != NULL)
    {
      g_object_unref (fo_table_row->padding_before);
    }
  fo_table_row->padding_before = new_padding_before;
  /*g_object_notify (G_OBJECT (fo_table_row), "padding-before");*/
}
...
**/
FoProperty *
fo_table_row_get_padding_bottom (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->padding_bottom;
}
 ...
 **/
void
fo_table_row_set_padding_bottom (FoFo *fo_fo,
		         FoProperty *new_padding_bottom)
{
  ...
  if (fo_table_row->padding_bottom != NULL)
    {
      g_object_unref (fo_table_row->padding_bottom);
    }
  fo_table_row->padding_bottom = new_padding_bottom;
  /*g_object_notify (G_OBJECT (fo_table_row), "padding-bottom");*/
}
...
**/
FoProperty *
fo_table_row_get_padding_end (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->padding_end;
}
 ...
 **/
void
fo_table_row_set_padding_end (FoFo *fo_fo,
		         FoProperty *new_padding_end)
{
  ...
  if (fo_table_row->padding_end != NULL)
    {
      g_object_unref (fo_table_row->padding_end);
    }
  fo_table_row->padding_end = new_padding_end;
  /*g_object_notify (G_OBJECT (fo_table_row), "padding-end");*/
}
...
**/
FoProperty *
fo_table_row_get_padding_left (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->padding_left;
}
 ...
 **/
void
fo_table_row_set_padding_left (FoFo *fo_fo,
		         FoProperty *new_padding_left)
{
  ...
  if (fo_table_row->padding_left != NULL)
    {
      g_object_unref (fo_table_row->padding_left);
    }
  fo_table_row->padding_left = new_padding_left;
  /*g_object_notify (G_OBJECT (fo_table_row), "padding-left");*/
}
...
**/
FoProperty *
fo_table_row_get_padding_right (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->padding_right;
}
 ...
 **/
void
fo_table_row_set_padding_right (FoFo *fo_fo,
		         FoProperty *new_padding_right)
{
  ...
  if (fo_table_row->padding_right != NULL)
    {
      g_object_unref (fo_table_row->padding_right);
    }
  fo_table_row->padding_right = new_padding_right;
  /*g_object_notify (G_OBJECT (fo_table_row), "padding-right");*/
}
...
**/
FoProperty *
fo_table_row_get_padding_start (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->padding_start;
}
 ...
 **/
void
fo_table_row_set_padding_start (FoFo *fo_fo,
		         FoProperty *new_padding_start)
{
  ...
  if (fo_table_row->padding_start != NULL)
    {
      g_object_unref (fo_table_row->padding_start);
    }
  fo_table_row->padding_start = new_padding_start;
  /*g_object_notify (G_OBJECT (fo_table_row), "padding-start");*/
}
...
**/
FoProperty *
fo_table_row_get_padding_top (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->padding_top;
}
 ...
 **/
void
fo_table_row_set_padding_top (FoFo *fo_fo,
		         FoProperty *new_padding_top)
{
  ...
  if (fo_table_row->padding_top != NULL)
    {
      g_object_unref (fo_table_row->padding_top);
    }
  fo_table_row->padding_top = new_padding_top;
  /*g_object_notify (G_OBJECT (fo_table_row), "padding-top");*/
}
...
**/
FoProperty *
fo_table_row_get_role (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
 ...
 **/
void
fo_table_row_set_role (FoFo *fo_fo,
		         FoProperty *new_role)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  if (fo_table_row->role != NULL)
    {
      g_object_unref (fo_table_row->role);
    }
  fo_table_row->role = new_role;
  /*g_object_notify (G_OBJECT (fo_table_row), "role");*/
}
...
**/
FoProperty *
fo_table_row_get_source_document (FoFo *fo_fo)
{
  FoTableRow *fo_table_row = (FoTableRow *) fo_fo;
  ...
  return fo_table_row->source_document;
}
 ...
 **/
void
fo_table_row_set_source_document (FoFo *fo_fo,
		         FoProperty *new_source_document)
{
  ...
  if (fo_table_row->source_document != NULL)
    {
      g_object_unref (fo_table_row->source_document);
    }
  fo_table_row->source_document = new_source_document;
  /*g_object_notify (G_OBJECT (fo_table_row), "source-document");*/
}
