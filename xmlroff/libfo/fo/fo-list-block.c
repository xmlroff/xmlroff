...
#include "fo/fo-list-block-private.h"
#include "fo-context-util.h"
#include "fo-block-fo-private.h"
#include "fo-list-block-area.h"
...
static void fo_list_block_init        (FoListBlock      *fo_list_block);
static void fo_list_block_class_init  (FoListBlockClass *klass);
static void fo_list_block_block_fo_init (FoBlockFoIface *iface);
static void fo_list_block_cbpbp_fo_init (FoCBPBPFoIface *iface);
static void fo_list_block_get_property (GObject      *object,
                                        guint         prop_id,
                                        GValue       *value,
                                        GParamSpec   *pspec);
static void fo_list_block_set_property (GObject      *object,
                                        guint         prop_id,
                                        const GValue *value,
                                        GParamSpec   *pspec);
static void fo_list_block_finalize    (GObject           *object);
static gboolean fo_list_block_validate_content (FoFo    *fo,
                                                GError **error);
static void fo_list_block_validate (FoFo      *fo,
                                    FoContext *current_context,
                                    FoContext *parent_context,
                                    GError   **error);
static void fo_list_block_update_from_context (FoFo      *fo,
                                               FoContext *context);
static void fo_list_block_debug_dump_properties (FoFo *fo,
                                                 gint  depth);
static void fo_list_block_set_label_end (FoFo *fo_fo,
					 FoDatatype *new_label_end);
static void fo_list_block_set_body_start (FoFo *fo_fo,
					  FoDatatype *new_body_start);

static gpointer parent_class;

/**
 * fo_list_block_get_type:
 * 
 * Register the #FoListBlock object type.
 * 
 * Return value: #GType value of the #FoListBlock object type.
 **/
GType
fo_list_block_get_type (void)
{
  ...
  if (!object_type)
	...
	{
	  sizeof (FoListBlockClass),
	  NULL,           /* base_init */
	  NULL,           /* base_finalize */
	  (GClassInitFunc) fo_list_block_class_init,
	  NULL,           /* class_finalize */
	  NULL,           /* class_data */
	  sizeof (FoListBlock),
	  0,              /* n_preallocs */
	  (GInstanceInitFunc) fo_list_block_init,
	  NULL		  /* value_table */
	};

      static const GInterfaceInfo fo_block_fo_info =
	{
	  (GInterfaceInitFunc) fo_list_block_block_fo_init,	 /* interface_init */
	  NULL,
	  NULL
	};
	...
	{
	  (GInterfaceInitFunc) fo_list_block_cbpbp_fo_init,	 /* interface_init */
	  NULL,
	  NULL
	};
...
/**
 * fo_list_block_init:
 * @fo_list_block: #FoListBlock object to initialise.
 * 
 * Implements #GInstanceInitFunc for #FoListBlock.
 **/
void
fo_list_block_init (FoListBlock *fo_list_block)
{
  fo_list_block->label_end = fo_length_new_with_value (6.0);
  fo_list_block->body_start = fo_length_new_with_value (24.0);
}

/**
 * fo_list_block_class_init:
 * @klass: #FoListBlockClass object to initialise.
 * 
 * Implements #GClassInitFunc for #FoListBlockClass.
 **/
void
fo_list_block_class_init (FoListBlockClass *klass)
{
  ...
  object_class->finalize = fo_list_block_finalize;

  object_class->get_property = fo_list_block_get_property;
  object_class->set_property = fo_list_block_set_property;

  fofo_class->validate_content =
    fo_list_block_validate_content;
  fofo_class->validate2 =
    fo_list_block_validate;
  ...
  g_object_class_install_property
    (object_class,
     PROP_LABEL_END,
     g_param_spec_object ("label-end",
			  _("Label End"),
			  _("Label End property"),
			  FO_TYPE_DATATYPE,
			  G_PARAM_READABLE));
  g_object_class_install_property
    (object_class,
     PROP_BODY_START,
     g_param_spec_object ("body-start",
			  _("Body Start"),
			  _("Body Start property"),
			  FO_TYPE_DATATYPE,
			  G_PARAM_READABLE));
  g_object_class_install_property
    (object_class,
...
/**
 * fo_list_block_block_fo_init:
 * @iface: #FoBlockFoIFace structure for this class.
 * 
 * Initialize #FoBlockFoIface interface for this class.
 **/
void
fo_list_block_block_fo_init (FoBlockFoIface *iface)
{
  iface->get_background_color = fo_list_block_get_background_color;
  iface->get_border_after_color = fo_list_block_get_border_after_color;
  iface->get_border_after_style = fo_list_block_get_border_after_style;
  iface->get_border_after_width = fo_list_block_get_border_after_width;
  iface->get_border_before_color = fo_list_block_get_border_before_color;
  iface->get_border_before_style = fo_list_block_get_border_before_style;
  iface->get_border_before_width = fo_list_block_get_border_before_width;
  iface->get_border_end_color = fo_list_block_get_border_end_color;
  iface->get_border_end_style = fo_list_block_get_border_end_style;
  iface->get_border_end_width = fo_list_block_get_border_end_width;
  iface->get_border_start_color = fo_list_block_get_border_start_color;
  iface->get_border_start_style = fo_list_block_get_border_start_style;
  iface->get_border_start_width = fo_list_block_get_border_start_width;
  iface->get_keep_with_previous = fo_list_block_get_keep_with_previous;
  iface->get_keep_with_next = fo_list_block_get_keep_with_next;
  iface->get_keep_together = fo_list_block_get_keep_together;
  iface->get_padding_after = fo_list_block_get_padding_after;
  iface->get_padding_before = fo_list_block_get_padding_before;
  iface->get_padding_end = fo_list_block_get_padding_end;
  iface->get_padding_start = fo_list_block_get_padding_start;
  iface->get_space_before = fo_list_block_get_space_before;
  iface->get_space_after = fo_list_block_get_space_after;
  iface->get_start_indent = fo_list_block_get_start_indent;
  iface->get_end_indent = fo_list_block_get_end_indent;
}

/**
 * fo_list_block_cbpbp_fo_init:
 * @iface: #FoCBPBPFoIFace structure for this class.
 * 
 * Initialize #FoCBPBPFoIface interface for this class.
 **/
void
fo_list_block_cbpbp_fo_init (FoCBPBPFoIface *iface)
{
  iface->get_background_color = fo_list_block_get_background_color;
  iface->get_border_after_color = fo_list_block_get_border_after_color;
  iface->get_border_after_style = fo_list_block_get_border_after_style;
...
/**
 * fo_list_block_finalize:
 * @object: #FoListBlock object to finalize.
 * 
 * Implements #GObjectFinalizeFunc for #FoListBlock.
 **/
void
fo_list_block_finalize (GObject *object)
{
  FoFo *fo = FO_FO (object);

  /* Release references to all property objects. */
  fo_list_block_set_background_color (fo, NULL);
  fo_list_block_set_background_image (fo, NULL);
  fo_list_block_set_border_after_color (fo, NULL);
  fo_list_block_set_border_after_style (fo, NULL);
  fo_list_block_set_border_after_width (fo, NULL);
  fo_list_block_set_border_before_color (fo, NULL);
  fo_list_block_set_border_before_style (fo, NULL);
  fo_list_block_set_border_before_width (fo, NULL);
  fo_list_block_set_border_bottom_color (fo, NULL);
  fo_list_block_set_border_bottom_style (fo, NULL);
  fo_list_block_set_border_bottom_width (fo, NULL);
  fo_list_block_set_border_end_color (fo, NULL);
  fo_list_block_set_border_end_style (fo, NULL);
  fo_list_block_set_border_end_width (fo, NULL);
  fo_list_block_set_border_left_color (fo, NULL);
  fo_list_block_set_border_left_style (fo, NULL);
  fo_list_block_set_border_left_width (fo, NULL);
  fo_list_block_set_border_right_color (fo, NULL);
  fo_list_block_set_border_right_style (fo, NULL);
  fo_list_block_set_border_right_width (fo, NULL);
  fo_list_block_set_border_start_color (fo, NULL);
  fo_list_block_set_border_start_style (fo, NULL);
  fo_list_block_set_border_start_width (fo, NULL);
  fo_list_block_set_border_top_color (fo, NULL);
  fo_list_block_set_border_top_style (fo, NULL);
  fo_list_block_set_border_top_width (fo, NULL);
  fo_list_block_set_break_after (fo, NULL);
  fo_list_block_set_break_before (fo, NULL);
  fo_list_block_set_end_indent (fo, NULL);
  fo_list_block_set_id (fo, NULL);
  fo_list_block_set_keep_together (fo, NULL);
  fo_list_block_set_keep_together_within_column (fo, NULL);
  fo_list_block_set_keep_together_within_line (fo, NULL);
  fo_list_block_set_keep_together_within_page (fo, NULL);
  fo_list_block_set_keep_with_next (fo, NULL);
  fo_list_block_set_keep_with_next_within_column (fo, NULL);
  fo_list_block_set_keep_with_next_within_line (fo, NULL);
  fo_list_block_set_keep_with_next_within_page (fo, NULL);
  fo_list_block_set_keep_with_previous (fo, NULL);
  fo_list_block_set_keep_with_previous_within_column (fo, NULL);
  fo_list_block_set_keep_with_previous_within_line (fo, NULL);
  fo_list_block_set_keep_with_previous_within_page (fo, NULL);
  fo_list_block_set_margin_bottom (fo, NULL);
  fo_list_block_set_margin_left (fo, NULL);
  fo_list_block_set_margin_right (fo, NULL);
  fo_list_block_set_margin_top (fo, NULL);
  fo_list_block_set_padding_after (fo, NULL);
  fo_list_block_set_padding_before (fo, NULL);
  fo_list_block_set_padding_bottom (fo, NULL);
  fo_list_block_set_padding_end (fo, NULL);
  fo_list_block_set_padding_left (fo, NULL);
  fo_list_block_set_padding_right (fo, NULL);
  fo_list_block_set_padding_start (fo, NULL);
  fo_list_block_set_padding_top (fo, NULL);
  fo_list_block_set_provisional_distance_between_starts (fo, NULL);
  fo_list_block_set_provisional_label_separation (fo, NULL);
  fo_list_block_set_role (fo, NULL);
  fo_list_block_set_source_document (fo, NULL);
  fo_list_block_set_space_after (fo, NULL);
  fo_list_block_set_space_before (fo, NULL);
  fo_list_block_set_start_indent (fo, NULL);

  G_OBJECT_CLASS (parent_class)->finalize (object);
}

/**
 * fo_list_block_get_property:
 * @object:  #GObject whose property will be retrieved.
 * @prop_id: Property ID assigned when property registered.
 * @value:   GValue to set with property value.
 * @pspec:   Parameter specification for this property type.
 * 
 * Implements #GObjectGetPropertyFunc for #FoListBlock.
 **/
void
fo_list_block_get_property (GObject    *object,
                            guint       prop_id,
                            GValue     *value,
                            GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_LABEL_END:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_label_end (fo_fo)));
      break;
    case PROP_BODY_START:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_body_start (fo_fo)));
      break;
    case PROP_BACKGROUND_COLOR:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_background_color (fo_fo)));
      break;
    case PROP_BACKGROUND_IMAGE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_background_image (fo_fo)));
      break;
    case PROP_BORDER_AFTER_COLOR:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_after_color (fo_fo)));
      break;
    case PROP_BORDER_AFTER_STYLE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_after_style (fo_fo)));
      break;
    case PROP_BORDER_AFTER_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_after_width (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_COLOR:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_before_color (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_STYLE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_before_style (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_before_width (fo_fo)));
      break;
    case PROP_BORDER_BOTTOM_COLOR:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_bottom_color (fo_fo)));
      break;
    case PROP_BORDER_BOTTOM_STYLE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_bottom_style (fo_fo)));
      break;
    case PROP_BORDER_BOTTOM_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_bottom_width (fo_fo)));
      break;
    case PROP_BORDER_END_COLOR:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_end_color (fo_fo)));
      break;
    case PROP_BORDER_END_STYLE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_end_style (fo_fo)));
      break;
    case PROP_BORDER_END_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_end_width (fo_fo)));
      break;
    case PROP_BORDER_LEFT_COLOR:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_left_color (fo_fo)));
      break;
    case PROP_BORDER_LEFT_STYLE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_left_style (fo_fo)));
      break;
    case PROP_BORDER_LEFT_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_left_width (fo_fo)));
      break;
    case PROP_BORDER_RIGHT_COLOR:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_right_color (fo_fo)));
      break;
    case PROP_BORDER_RIGHT_STYLE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_right_style (fo_fo)));
      break;
    case PROP_BORDER_RIGHT_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_right_width (fo_fo)));
      break;
    case PROP_BORDER_START_COLOR:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_start_color (fo_fo)));
      break;
    case PROP_BORDER_START_STYLE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_start_style (fo_fo)));
      break;
    case PROP_BORDER_START_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_start_width (fo_fo)));
      break;
    case PROP_BORDER_TOP_COLOR:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_top_color (fo_fo)));
      break;
    case PROP_BORDER_TOP_STYLE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_top_style (fo_fo)));
      break;
    case PROP_BORDER_TOP_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_border_top_width (fo_fo)));
      break;
    case PROP_BREAK_AFTER:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_break_after (fo_fo)));
      break;
    case PROP_BREAK_BEFORE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_break_before (fo_fo)));
      break;
    case PROP_END_INDENT:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_end_indent (fo_fo)));
      break;
    case PROP_ID:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_id (fo_fo)));
      break;
    case PROP_KEEP_TOGETHER:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_together (fo_fo)));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_COLUMN:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_together_within_column (fo_fo)));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_LINE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_together_within_line (fo_fo)));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_PAGE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_together_within_page (fo_fo)));
      break;
    case PROP_KEEP_WITH_NEXT:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_with_next (fo_fo)));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_COLUMN:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_with_next_within_column (fo_fo)));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_LINE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_with_next_within_line (fo_fo)));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_PAGE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_with_next_within_page (fo_fo)));
      break;
    case PROP_KEEP_WITH_PREVIOUS:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_with_previous (fo_fo)));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_COLUMN:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_with_previous_within_column (fo_fo)));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_LINE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_with_previous_within_line (fo_fo)));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_PAGE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_keep_with_previous_within_page (fo_fo)));
      break;
    case PROP_MARGIN_BOTTOM:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_margin_bottom (fo_fo)));
      break;
    case PROP_MARGIN_LEFT:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_margin_left (fo_fo)));
      break;
    case PROP_MARGIN_RIGHT:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_margin_right (fo_fo)));
      break;
    case PROP_MARGIN_TOP:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_margin_top (fo_fo)));
      break;
    case PROP_PADDING_AFTER:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_padding_after (fo_fo)));
      break;
    case PROP_PADDING_BEFORE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_padding_before (fo_fo)));
      break;
    case PROP_PADDING_BOTTOM:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_padding_bottom (fo_fo)));
      break;
    case PROP_PADDING_END:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_padding_end (fo_fo)));
      break;
    case PROP_PADDING_LEFT:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_padding_left (fo_fo)));
      break;
    case PROP_PADDING_RIGHT:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_padding_right (fo_fo)));
      break;
    case PROP_PADDING_START:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_padding_start (fo_fo)));
      break;
    case PROP_PADDING_TOP:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_padding_top (fo_fo)));
      break;
    case PROP_PROVISIONAL_DISTANCE_BETWEEN_STARTS:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_provisional_distance_between_starts (fo_fo)));
      break;
    case PROP_PROVISIONAL_LABEL_SEPARATION:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_provisional_label_separation (fo_fo)));
      break;
    case PROP_ROLE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_role (fo_fo)));
      break;
    case PROP_SOURCE_DOCUMENT:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_source_document (fo_fo)));
      break;
    case PROP_SPACE_AFTER:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_space_after (fo_fo)));
      break;
    case PROP_SPACE_BEFORE:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_space_before (fo_fo)));
      break;
    case PROP_START_INDENT:
      g_value_set_object (value, G_OBJECT (fo_list_block_get_start_indent (fo_fo)));
      break;
    default:
...
/**
 * fo_list_block_set_property:
 * @object:  #GObject whose property will be set.
 * @prop_id: Property ID assigned when property registered.
 * @value:   New value for property.
 * @pspec:   Parameter specification for this property type.
 * 
 * Implements #GObjectSetPropertyFunc for #FoListBlock.
 **/
void
fo_list_block_set_property (GObject      *object,
                            guint         prop_id,
                            const GValue *value,
                            GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_BACKGROUND_COLOR:
      fo_list_block_set_background_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BACKGROUND_IMAGE:
      fo_list_block_set_background_image (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_COLOR:
      fo_list_block_set_border_after_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_STYLE:
      fo_list_block_set_border_after_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_WIDTH:
      fo_list_block_set_border_after_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_COLOR:
      fo_list_block_set_border_before_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_STYLE:
      fo_list_block_set_border_before_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_WIDTH:
      fo_list_block_set_border_before_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BOTTOM_COLOR:
      fo_list_block_set_border_bottom_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BOTTOM_STYLE:
      fo_list_block_set_border_bottom_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BOTTOM_WIDTH:
      fo_list_block_set_border_bottom_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_COLOR:
      fo_list_block_set_border_end_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_STYLE:
      fo_list_block_set_border_end_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_WIDTH:
      fo_list_block_set_border_end_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_LEFT_COLOR:
      fo_list_block_set_border_left_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_LEFT_STYLE:
      fo_list_block_set_border_left_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_LEFT_WIDTH:
      fo_list_block_set_border_left_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_RIGHT_COLOR:
      fo_list_block_set_border_right_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_RIGHT_STYLE:
      fo_list_block_set_border_right_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_RIGHT_WIDTH:
      fo_list_block_set_border_right_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_COLOR:
      fo_list_block_set_border_start_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_STYLE:
      fo_list_block_set_border_start_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_WIDTH:
      fo_list_block_set_border_start_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_TOP_COLOR:
      fo_list_block_set_border_top_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_TOP_STYLE:
      fo_list_block_set_border_top_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_TOP_WIDTH:
      fo_list_block_set_border_top_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BREAK_AFTER:
      fo_list_block_set_break_after (fo_fo, g_value_get_object (value));
      break;
    case PROP_BREAK_BEFORE:
      fo_list_block_set_break_before (fo_fo, g_value_get_object (value));
      break;
    case PROP_END_INDENT:
      fo_list_block_set_end_indent (fo_fo, g_value_get_object (value));
      break;
    case PROP_ID:
      fo_list_block_set_id (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_TOGETHER:
      fo_list_block_set_keep_together (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_COLUMN:
      fo_list_block_set_keep_together_within_column (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_LINE:
      fo_list_block_set_keep_together_within_line (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_TOGETHER_WITHIN_PAGE:
      fo_list_block_set_keep_together_within_page (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_NEXT:
      fo_list_block_set_keep_with_next (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_COLUMN:
      fo_list_block_set_keep_with_next_within_column (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_LINE:
      fo_list_block_set_keep_with_next_within_line (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_NEXT_WITHIN_PAGE:
      fo_list_block_set_keep_with_next_within_page (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_PREVIOUS:
      fo_list_block_set_keep_with_previous (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_COLUMN:
      fo_list_block_set_keep_with_previous_within_column (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_LINE:
      fo_list_block_set_keep_with_previous_within_line (fo_fo, g_value_get_object (value));
      break;
    case PROP_KEEP_WITH_PREVIOUS_WITHIN_PAGE:
      fo_list_block_set_keep_with_previous_within_page (fo_fo, g_value_get_object (value));
      break;
    case PROP_MARGIN_BOTTOM:
      fo_list_block_set_margin_bottom (fo_fo, g_value_get_object (value));
      break;
    case PROP_MARGIN_LEFT:
      fo_list_block_set_margin_left (fo_fo, g_value_get_object (value));
      break;
    case PROP_MARGIN_RIGHT:
      fo_list_block_set_margin_right (fo_fo, g_value_get_object (value));
      break;
    case PROP_MARGIN_TOP:
      fo_list_block_set_margin_top (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_AFTER:
      fo_list_block_set_padding_after (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_BEFORE:
      fo_list_block_set_padding_before (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_BOTTOM:
      fo_list_block_set_padding_bottom (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_END:
      fo_list_block_set_padding_end (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_LEFT:
      fo_list_block_set_padding_left (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_RIGHT:
      fo_list_block_set_padding_right (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_START:
      fo_list_block_set_padding_start (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_TOP:
      fo_list_block_set_padding_top (fo_fo, g_value_get_object (value));
      break;
    case PROP_PROVISIONAL_DISTANCE_BETWEEN_STARTS:
      fo_list_block_set_provisional_distance_between_starts (fo_fo, g_value_get_object (value));
      break;
    case PROP_PROVISIONAL_LABEL_SEPARATION:
      fo_list_block_set_provisional_label_separation (fo_fo, g_value_get_object (value));
      break;
    case PROP_ROLE:
      fo_list_block_set_role (fo_fo, g_value_get_object (value));
      break;
    case PROP_SOURCE_DOCUMENT:
      fo_list_block_set_source_document (fo_fo, g_value_get_object (value));
      break;
    case PROP_SPACE_AFTER:
      fo_list_block_set_space_after (fo_fo, g_value_get_object (value));
      break;
    case PROP_SPACE_BEFORE:
      fo_list_block_set_space_before (fo_fo, g_value_get_object (value));
      break;
    case PROP_START_INDENT:
      fo_list_block_set_start_indent (fo_fo, g_value_get_object (value));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
 ...
 * 
 * Return value: the new #FoListBlock.
 **/
FoFo*
fo_list_block_new (void)
{
  return FO_FO (g_object_new (fo_list_block_get_type (),
                              NULL));
}

/**
 * fo_list_block_validate_content:
 * @fo:    #FoListBlock object to validate.
 ...
 **/
gboolean
fo_list_block_validate_content (FoFo    *fo,
                                GError **error)
{
  GError *tmp_error;
  FoNode *fo_node;
  ...
  g_return_val_if_fail (FO_IS_LIST_BLOCK (fo), TRUE);
 ...
 **/
void
fo_list_block_validate (FoFo      *fo,
                        FoContext *current_context,
                        FoContext *parent_context,
                        GError   **error)
{
  FoListBlock *fo_list_block;

  g_return_if_fail (fo != NULL);
  g_return_if_fail (FO_IS_LIST_BLOCK (fo));
  g_return_if_fail (FO_IS_CONTEXT (current_context));
  g_return_if_fail (FO_IS_CONTEXT (parent_context));
  g_return_if_fail (error == NULL || *error == NULL);

  fo_list_block = FO_LIST_BLOCK (fo);
...
/**
 * fo_list_block_set_label_end:
 * @fo_fo:  #FoListBlock object whose "label-end" is to be set
 * @new_label_end: New "label-end" property value
 * 
 * Sets the "label-end" property of @property
 **/
void
fo_list_block_set_label_end (FoFo *fo_fo,
			     FoDatatype *new_label_end)
{
  FoListBlock *fo_list_block;

  g_return_if_fail (fo_fo != NULL);
  g_return_if_fail (FO_IS_LIST_BLOCK (fo_fo));

  fo_list_block = (FoListBlock *) fo_fo;

  if (new_label_end)
    g_object_ref (G_OBJECT (new_label_end));
  if (fo_list_block->label_end)
    g_object_unref (G_OBJECT (fo_list_block->label_end));
  fo_list_block->label_end = new_label_end;
  /*g_object_notify (G_OBJECT(fo_list_block), "label-end");*/
}

/**
 * fo_list_block_get_label_end:
 * @fo_fo: The #FoListBlock object
 *
 * Gets the #label-end of @fo_fo
 *
 * Return value: The value to use for label-end() functions
**/
FoDatatype*
fo_list_block_get_label_end (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  gfloat label_end;

  g_return_val_if_fail (fo_list_block != NULL, NULL);
  g_return_val_if_fail (FO_IS_LIST_BLOCK (fo_list_block), NULL);

#if defined(LIBFO_DEBUG) && 0
  g_message ("get_label_end:: content rectangle: %f; pdbs: %f; start-indent: %f; start-intrusion-adjustment: %f; pls: %f",
  ...
  fo_list_block_set_label_end (fo_fo,
			       fo_length_new_with_value (label_end));

  return fo_list_block->label_end;
}

/**
 * fo_list_block_set_body_start:
 * @fo_fo:  #FoListBlock object whose "body-start" is to be set
 * @new_body_start: New "body-start" property value
 * 
 * Sets the "body-start" property of @property
 **/
void
fo_list_block_set_body_start (FoFo *fo_fo,
			      FoDatatype *new_body_start)
{
  FoListBlock *fo_list_block;
  ...
  if (new_body_start)
    g_object_ref (G_OBJECT (new_body_start));
  if (fo_list_block->body_start)
    g_object_unref (G_OBJECT (fo_list_block->body_start));
  fo_list_block->body_start = new_body_start;
  /*g_object_notify (G_OBJECT(fo_list_block), "body-start");*/
}
 ...
 *
 * Return value: The value to use for body_start() functions
**/
FoDatatype*
fo_list_block_get_body_start (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  gfloat body_start;
...
#if defined(LIBFO_DEBUG) && 0
  g_message ("get_body_start:: start-indent: %f; start-intrusion-adjustment: %f; pdbs: %f",
	     fo_area_area_get_start_indent (fo_fo->areas->data),
	     0.0,
	     fo_length_get_value (fo_property_get_value (fo_list_block_get_provisional_distance_between_starts (fo_fo))));
#endif
  ...
  body_start =
    fo_area_area_get_start_indent (fo_fo->areas->data) -
    fo_area_area_get_x (fo_fo->areas->data) +
    fo_length_get_value (fo_property_get_value (fo_list_block_get_provisional_distance_between_starts (fo_fo)));

  fo_list_block_set_body_start (fo_fo,
				fo_length_new_with_value (body_start));

  return fo_list_block->body_start;
}

/**
 * fo_list_block_update_from_context:
 * @fo:      The #FoFo object.
 ...
 **/
void
fo_list_block_update_from_context (FoFo      *fo,
                                   FoContext *context)
{
  g_return_if_fail (fo != NULL);
  g_return_if_fail (FO_IS_LIST_BLOCK (fo));
  ...
  fo_list_block_set_background_color (fo,
			  fo_context_get_background_color (context));
  fo_list_block_set_background_image (fo,
			  fo_context_get_background_image (context));
  fo_list_block_set_border_after_color (fo,
			  fo_context_get_border_after_color (context));
  fo_list_block_set_border_after_style (fo,
			  fo_context_get_border_after_style (context));
  fo_list_block_set_border_after_width (fo,
			  fo_context_get_border_after_width (context));
  fo_list_block_set_border_before_color (fo,
			  fo_context_get_border_before_color (context));
  fo_list_block_set_border_before_style (fo,
			  fo_context_get_border_before_style (context));
  fo_list_block_set_border_before_width (fo,
			  fo_context_get_border_before_width (context));
  fo_list_block_set_border_bottom_color (fo,
			  fo_context_get_border_bottom_color (context));
  fo_list_block_set_border_bottom_style (fo,
			  fo_context_get_border_bottom_style (context));
  fo_list_block_set_border_bottom_width (fo,
			  fo_context_get_border_bottom_width (context));
  fo_list_block_set_border_end_color (fo,
			  fo_context_get_border_end_color (context));
  fo_list_block_set_border_end_style (fo,
			  fo_context_get_border_end_style (context));
  fo_list_block_set_border_end_width (fo,
			  fo_context_get_border_end_width (context));
  fo_list_block_set_border_left_color (fo,
			  fo_context_get_border_left_color (context));
  fo_list_block_set_border_left_style (fo,
			  fo_context_get_border_left_style (context));
  fo_list_block_set_border_left_width (fo,
			  fo_context_get_border_left_width (context));
  fo_list_block_set_border_right_color (fo,
			  fo_context_get_border_right_color (context));
  fo_list_block_set_border_right_style (fo,
			  fo_context_get_border_right_style (context));
  fo_list_block_set_border_right_width (fo,
			  fo_context_get_border_right_width (context));
  fo_list_block_set_border_start_color (fo,
			  fo_context_get_border_start_color (context));
  fo_list_block_set_border_start_style (fo,
			  fo_context_get_border_start_style (context));
  fo_list_block_set_border_start_width (fo,
			  fo_context_get_border_start_width (context));
  fo_list_block_set_border_top_color (fo,
			  fo_context_get_border_top_color (context));
  fo_list_block_set_border_top_style (fo,
			  fo_context_get_border_top_style (context));
  fo_list_block_set_border_top_width (fo,
			  fo_context_get_border_top_width (context));
  fo_list_block_set_break_after (fo,
			  fo_context_get_break_after (context));
  fo_list_block_set_break_before (fo,
			  fo_context_get_break_before (context));
  fo_list_block_set_end_indent (fo,
			  fo_context_get_end_indent (context));
  fo_list_block_set_id (fo,
			  fo_context_get_id (context));
  fo_list_block_set_keep_together (fo,
			  fo_context_get_keep_together (context));
  fo_list_block_set_keep_together_within_column (fo,
			  fo_context_get_keep_together_within_column (context));
  fo_list_block_set_keep_together_within_line (fo,
			  fo_context_get_keep_together_within_line (context));
  fo_list_block_set_keep_together_within_page (fo,
			  fo_context_get_keep_together_within_page (context));
  fo_list_block_set_keep_with_next (fo,
			  fo_context_get_keep_with_next (context));
  fo_list_block_set_keep_with_next_within_column (fo,
			  fo_context_get_keep_with_next_within_column (context));
  fo_list_block_set_keep_with_next_within_line (fo,
			  fo_context_get_keep_with_next_within_line (context));
  fo_list_block_set_keep_with_next_within_page (fo,
			  fo_context_get_keep_with_next_within_page (context));
  fo_list_block_set_keep_with_previous (fo,
			  fo_context_get_keep_with_previous (context));
  fo_list_block_set_keep_with_previous_within_column (fo,
			  fo_context_get_keep_with_previous_within_column (context));
  fo_list_block_set_keep_with_previous_within_line (fo,
			  fo_context_get_keep_with_previous_within_line (context));
  fo_list_block_set_keep_with_previous_within_page (fo,
			  fo_context_get_keep_with_previous_within_page (context));
  fo_list_block_set_margin_bottom (fo,
			  fo_context_get_margin_bottom (context));
  fo_list_block_set_margin_left (fo,
			  fo_context_get_margin_left (context));
  fo_list_block_set_margin_right (fo,
			  fo_context_get_margin_right (context));
  fo_list_block_set_margin_top (fo,
			  fo_context_get_margin_top (context));
  fo_list_block_set_padding_after (fo,
			  fo_context_get_padding_after (context));
  fo_list_block_set_padding_before (fo,
			  fo_context_get_padding_before (context));
  fo_list_block_set_padding_bottom (fo,
			  fo_context_get_padding_bottom (context));
  fo_list_block_set_padding_end (fo,
			  fo_context_get_padding_end (context));
  fo_list_block_set_padding_left (fo,
			  fo_context_get_padding_left (context));
  fo_list_block_set_padding_right (fo,
			  fo_context_get_padding_right (context));
  fo_list_block_set_padding_start (fo,
			  fo_context_get_padding_start (context));
  fo_list_block_set_padding_top (fo,
			  fo_context_get_padding_top (context));
  fo_list_block_set_provisional_distance_between_starts (fo,
			  fo_context_get_provisional_distance_between_starts (context));
  fo_list_block_set_provisional_label_separation (fo,
			  fo_context_get_provisional_label_separation (context));
  fo_list_block_set_role (fo,
			  fo_context_get_role (context));
  fo_list_block_set_source_document (fo,
			  fo_context_get_source_document (context));
  fo_list_block_set_space_after (fo,
			  fo_context_get_space_after (context));
  fo_list_block_set_space_before (fo,
			  fo_context_get_space_before (context));
  fo_list_block_set_start_indent (fo,
			  fo_context_get_start_indent (context));
}

/**
 * fo_list_block_debug_dump_properties:
 * @fo:    The #FoFo object.
 ...
 **/
void
fo_list_block_debug_dump_properties (FoFo *fo,
                                     gint  depth)
{
  FoListBlock *fo_list_block;
  ...
  fo_object_debug_dump (fo_list_block->background_color, depth);
  fo_object_debug_dump (fo_list_block->background_image, depth);
  fo_object_debug_dump (fo_list_block->border_after_color, depth);
  fo_object_debug_dump (fo_list_block->border_after_style, depth);
  fo_object_debug_dump (fo_list_block->border_after_width, depth);
  fo_object_debug_dump (fo_list_block->border_before_color, depth);
  fo_object_debug_dump (fo_list_block->border_before_style, depth);
  fo_object_debug_dump (fo_list_block->border_before_width, depth);
  fo_object_debug_dump (fo_list_block->border_bottom_color, depth);
  fo_object_debug_dump (fo_list_block->border_bottom_style, depth);
  fo_object_debug_dump (fo_list_block->border_bottom_width, depth);
  fo_object_debug_dump (fo_list_block->border_end_color, depth);
  fo_object_debug_dump (fo_list_block->border_end_style, depth);
  fo_object_debug_dump (fo_list_block->border_end_width, depth);
  fo_object_debug_dump (fo_list_block->border_left_color, depth);
  fo_object_debug_dump (fo_list_block->border_left_style, depth);
  fo_object_debug_dump (fo_list_block->border_left_width, depth);
  fo_object_debug_dump (fo_list_block->border_right_color, depth);
  fo_object_debug_dump (fo_list_block->border_right_style, depth);
  fo_object_debug_dump (fo_list_block->border_right_width, depth);
  fo_object_debug_dump (fo_list_block->border_start_color, depth);
  fo_object_debug_dump (fo_list_block->border_start_style, depth);
  fo_object_debug_dump (fo_list_block->border_start_width, depth);
  fo_object_debug_dump (fo_list_block->border_top_color, depth);
  fo_object_debug_dump (fo_list_block->border_top_style, depth);
  fo_object_debug_dump (fo_list_block->border_top_width, depth);
  fo_object_debug_dump (fo_list_block->break_after, depth);
  fo_object_debug_dump (fo_list_block->break_before, depth);
  fo_object_debug_dump (fo_list_block->end_indent, depth);
  fo_object_debug_dump (fo_list_block->id, depth);
  fo_object_debug_dump (fo_list_block->keep_together, depth);
  fo_object_debug_dump (fo_list_block->keep_together_within_column, depth);
  fo_object_debug_dump (fo_list_block->keep_together_within_line, depth);
  fo_object_debug_dump (fo_list_block->keep_together_within_page, depth);
  fo_object_debug_dump (fo_list_block->keep_with_next, depth);
  fo_object_debug_dump (fo_list_block->keep_with_next_within_column, depth);
  fo_object_debug_dump (fo_list_block->keep_with_next_within_line, depth);
  fo_object_debug_dump (fo_list_block->keep_with_next_within_page, depth);
  fo_object_debug_dump (fo_list_block->keep_with_previous, depth);
  fo_object_debug_dump (fo_list_block->keep_with_previous_within_column, depth);
  fo_object_debug_dump (fo_list_block->keep_with_previous_within_line, depth);
  fo_object_debug_dump (fo_list_block->keep_with_previous_within_page, depth);
  fo_object_debug_dump (fo_list_block->margin_bottom, depth);
  fo_object_debug_dump (fo_list_block->margin_left, depth);
  fo_object_debug_dump (fo_list_block->margin_right, depth);
  fo_object_debug_dump (fo_list_block->margin_top, depth);
  fo_object_debug_dump (fo_list_block->padding_after, depth);
  fo_object_debug_dump (fo_list_block->padding_before, depth);
  fo_object_debug_dump (fo_list_block->padding_bottom, depth);
  fo_object_debug_dump (fo_list_block->padding_end, depth);
  fo_object_debug_dump (fo_list_block->padding_left, depth);
  fo_object_debug_dump (fo_list_block->padding_right, depth);
  fo_object_debug_dump (fo_list_block->padding_start, depth);
  fo_object_debug_dump (fo_list_block->padding_top, depth);
  fo_object_debug_dump (fo_list_block->provisional_distance_between_starts, depth);
  fo_object_debug_dump (fo_list_block->provisional_label_separation, depth);
  fo_object_debug_dump (fo_list_block->role, depth);
  fo_object_debug_dump (fo_list_block->source_document, depth);
  fo_object_debug_dump (fo_list_block->space_after, depth);
  fo_object_debug_dump (fo_list_block->space_before, depth);
  fo_object_debug_dump (fo_list_block->start_indent, depth);
...
**/
FoProperty *
fo_list_block_get_background_color (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->background_color;
}
 ...
 **/
void
fo_list_block_set_background_color (FoFo *fo_fo,
		         FoProperty *new_background_color)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;

  g_return_if_fail (fo_list_block != NULL);
  g_return_if_fail (FO_IS_LIST_BLOCK (fo_list_block));
  ...
  if (fo_list_block->background_color != NULL)
    {
      g_object_unref (fo_list_block->background_color);
    }
  fo_list_block->background_color = new_background_color;
  /*g_object_notify (G_OBJECT (fo_list_block), "background-color");*/
}
...
**/
FoProperty *
fo_list_block_get_background_image (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->background_image;
}
 ...
 **/
void
fo_list_block_set_background_image (FoFo *fo_fo,
		         FoProperty *new_background_image)
{
  ...
  if (fo_list_block->background_image != NULL)
    {
      g_object_unref (fo_list_block->background_image);
    }
  fo_list_block->background_image = new_background_image;
  /*g_object_notify (G_OBJECT (fo_list_block), "background-image");*/
}
...
**/
FoProperty *
fo_list_block_get_border_after_color (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_after_color;
}
 ...
 **/
void
fo_list_block_set_border_after_color (FoFo *fo_fo,
		         FoProperty *new_border_after_color)
{
  ...
  if (fo_list_block->border_after_color != NULL)
    {
      g_object_unref (fo_list_block->border_after_color);
    }
  fo_list_block->border_after_color = new_border_after_color;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-after-color");*/
}
...
**/
FoProperty *
fo_list_block_get_border_after_style (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_after_style;
}
 ...
 **/
void
fo_list_block_set_border_after_style (FoFo *fo_fo,
		         FoProperty *new_border_after_style)
{
  ...
  if (fo_list_block->border_after_style != NULL)
    {
      g_object_unref (fo_list_block->border_after_style);
    }
  fo_list_block->border_after_style = new_border_after_style;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-after-style");*/
}
...
**/
FoProperty *
fo_list_block_get_border_after_width (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_after_width;
}
 ...
 **/
void
fo_list_block_set_border_after_width (FoFo *fo_fo,
		         FoProperty *new_border_after_width)
{
  ...
  if (fo_list_block->border_after_width != NULL)
    {
      g_object_unref (fo_list_block->border_after_width);
    }
  fo_list_block->border_after_width = new_border_after_width;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-after-width");*/
}
...
**/
FoProperty *
fo_list_block_get_border_before_color (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_before_color;
}
 ...
 **/
void
fo_list_block_set_border_before_color (FoFo *fo_fo,
		         FoProperty *new_border_before_color)
{
  ...
  if (fo_list_block->border_before_color != NULL)
    {
      g_object_unref (fo_list_block->border_before_color);
    }
  fo_list_block->border_before_color = new_border_before_color;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-before-color");*/
}
...
**/
FoProperty *
fo_list_block_get_border_before_style (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_before_style;
}
 ...
 **/
void
fo_list_block_set_border_before_style (FoFo *fo_fo,
		         FoProperty *new_border_before_style)
{
  ...
  if (fo_list_block->border_before_style != NULL)
    {
      g_object_unref (fo_list_block->border_before_style);
    }
  fo_list_block->border_before_style = new_border_before_style;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-before-style");*/
}
...
**/
FoProperty *
fo_list_block_get_border_before_width (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_before_width;
}
 ...
 **/
void
fo_list_block_set_border_before_width (FoFo *fo_fo,
		         FoProperty *new_border_before_width)
{
  ...
  if (fo_list_block->border_before_width != NULL)
    {
      g_object_unref (fo_list_block->border_before_width);
    }
  fo_list_block->border_before_width = new_border_before_width;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-before-width");*/
}
...
**/
FoProperty *
fo_list_block_get_border_bottom_color (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_bottom_color;
}
 ...
 **/
void
fo_list_block_set_border_bottom_color (FoFo *fo_fo,
		         FoProperty *new_border_bottom_color)
{
  ...
  if (fo_list_block->border_bottom_color != NULL)
    {
      g_object_unref (fo_list_block->border_bottom_color);
    }
  fo_list_block->border_bottom_color = new_border_bottom_color;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-bottom-color");*/
}
...
**/
FoProperty *
fo_list_block_get_border_bottom_style (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_bottom_style;
}
 ...
 **/
void
fo_list_block_set_border_bottom_style (FoFo *fo_fo,
		         FoProperty *new_border_bottom_style)
{
  ...
  if (fo_list_block->border_bottom_style != NULL)
    {
      g_object_unref (fo_list_block->border_bottom_style);
    }
  fo_list_block->border_bottom_style = new_border_bottom_style;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-bottom-style");*/
}
...
**/
FoProperty *
fo_list_block_get_border_bottom_width (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_bottom_width;
}
 ...
 **/
void
fo_list_block_set_border_bottom_width (FoFo *fo_fo,
		         FoProperty *new_border_bottom_width)
{
  ...
  if (fo_list_block->border_bottom_width != NULL)
    {
      g_object_unref (fo_list_block->border_bottom_width);
    }
  fo_list_block->border_bottom_width = new_border_bottom_width;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-bottom-width");*/
}
...
**/
FoProperty *
fo_list_block_get_border_end_color (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_end_color;
}
 ...
 **/
void
fo_list_block_set_border_end_color (FoFo *fo_fo,
		         FoProperty *new_border_end_color)
{
  ...
  if (fo_list_block->border_end_color != NULL)
    {
      g_object_unref (fo_list_block->border_end_color);
    }
  fo_list_block->border_end_color = new_border_end_color;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-end-color");*/
}
...
**/
FoProperty *
fo_list_block_get_border_end_style (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_end_style;
}
 ...
 **/
void
fo_list_block_set_border_end_style (FoFo *fo_fo,
		         FoProperty *new_border_end_style)
{
  ...
  if (fo_list_block->border_end_style != NULL)
    {
      g_object_unref (fo_list_block->border_end_style);
    }
  fo_list_block->border_end_style = new_border_end_style;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-end-style");*/
}
...
**/
FoProperty *
fo_list_block_get_border_end_width (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_end_width;
}
 ...
 **/
void
fo_list_block_set_border_end_width (FoFo *fo_fo,
		         FoProperty *new_border_end_width)
{
  ...
  if (fo_list_block->border_end_width != NULL)
    {
      g_object_unref (fo_list_block->border_end_width);
    }
  fo_list_block->border_end_width = new_border_end_width;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-end-width");*/
}
...
**/
FoProperty *
fo_list_block_get_border_left_color (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_left_color;
}
 ...
 **/
void
fo_list_block_set_border_left_color (FoFo *fo_fo,
		         FoProperty *new_border_left_color)
{
  ...
  if (fo_list_block->border_left_color != NULL)
    {
      g_object_unref (fo_list_block->border_left_color);
    }
  fo_list_block->border_left_color = new_border_left_color;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-left-color");*/
}
...
**/
FoProperty *
fo_list_block_get_border_left_style (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_left_style;
}
 ...
 **/
void
fo_list_block_set_border_left_style (FoFo *fo_fo,
		         FoProperty *new_border_left_style)
{
  ...
  if (fo_list_block->border_left_style != NULL)
    {
      g_object_unref (fo_list_block->border_left_style);
    }
  fo_list_block->border_left_style = new_border_left_style;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-left-style");*/
}
...
**/
FoProperty *
fo_list_block_get_border_left_width (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_left_width;
}
 ...
 **/
void
fo_list_block_set_border_left_width (FoFo *fo_fo,
		         FoProperty *new_border_left_width)
{
  ...
  if (fo_list_block->border_left_width != NULL)
    {
      g_object_unref (fo_list_block->border_left_width);
    }
  fo_list_block->border_left_width = new_border_left_width;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-left-width");*/
}
...
**/
FoProperty *
fo_list_block_get_border_right_color (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_right_color;
}
 ...
 **/
void
fo_list_block_set_border_right_color (FoFo *fo_fo,
		         FoProperty *new_border_right_color)
{
  ...
  if (fo_list_block->border_right_color != NULL)
    {
      g_object_unref (fo_list_block->border_right_color);
    }
  fo_list_block->border_right_color = new_border_right_color;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-right-color");*/
}
...
**/
FoProperty *
fo_list_block_get_border_right_style (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_right_style;
}
 ...
 **/
void
fo_list_block_set_border_right_style (FoFo *fo_fo,
		         FoProperty *new_border_right_style)
{
  ...
  if (fo_list_block->border_right_style != NULL)
    {
      g_object_unref (fo_list_block->border_right_style);
    }
  fo_list_block->border_right_style = new_border_right_style;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-right-style");*/
}
...
**/
FoProperty *
fo_list_block_get_border_right_width (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_right_width;
}
 ...
 **/
void
fo_list_block_set_border_right_width (FoFo *fo_fo,
		         FoProperty *new_border_right_width)
{
  ...
  if (fo_list_block->border_right_width != NULL)
    {
      g_object_unref (fo_list_block->border_right_width);
    }
  fo_list_block->border_right_width = new_border_right_width;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-right-width");*/
}
...
**/
FoProperty *
fo_list_block_get_border_start_color (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_start_color;
}
 ...
 **/
void
fo_list_block_set_border_start_color (FoFo *fo_fo,
		         FoProperty *new_border_start_color)
{
  ...
  if (fo_list_block->border_start_color != NULL)
    {
      g_object_unref (fo_list_block->border_start_color);
    }
  fo_list_block->border_start_color = new_border_start_color;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-start-color");*/
}
...
**/
FoProperty *
fo_list_block_get_border_start_style (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_start_style;
}
 ...
 **/
void
fo_list_block_set_border_start_style (FoFo *fo_fo,
		         FoProperty *new_border_start_style)
{
  ...
  if (fo_list_block->border_start_style != NULL)
    {
      g_object_unref (fo_list_block->border_start_style);
    }
  fo_list_block->border_start_style = new_border_start_style;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-start-style");*/
}
...
**/
FoProperty *
fo_list_block_get_border_start_width (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_start_width;
}
 ...
 **/
void
fo_list_block_set_border_start_width (FoFo *fo_fo,
		         FoProperty *new_border_start_width)
{
  ...
  if (fo_list_block->border_start_width != NULL)
    {
      g_object_unref (fo_list_block->border_start_width);
    }
  fo_list_block->border_start_width = new_border_start_width;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-start-width");*/
}
...
**/
FoProperty *
fo_list_block_get_border_top_color (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_top_color;
}
 ...
 **/
void
fo_list_block_set_border_top_color (FoFo *fo_fo,
		         FoProperty *new_border_top_color)
{
  ...
  if (fo_list_block->border_top_color != NULL)
    {
      g_object_unref (fo_list_block->border_top_color);
    }
  fo_list_block->border_top_color = new_border_top_color;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-top-color");*/
}
...
**/
FoProperty *
fo_list_block_get_border_top_style (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_top_style;
}
 ...
 **/
void
fo_list_block_set_border_top_style (FoFo *fo_fo,
		         FoProperty *new_border_top_style)
{
  ...
  if (fo_list_block->border_top_style != NULL)
    {
      g_object_unref (fo_list_block->border_top_style);
    }
  fo_list_block->border_top_style = new_border_top_style;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-top-style");*/
}
...
**/
FoProperty *
fo_list_block_get_border_top_width (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->border_top_width;
}
 ...
 **/
void
fo_list_block_set_border_top_width (FoFo *fo_fo,
		         FoProperty *new_border_top_width)
{
  ...
  if (fo_list_block->border_top_width != NULL)
    {
      g_object_unref (fo_list_block->border_top_width);
    }
  fo_list_block->border_top_width = new_border_top_width;
  /*g_object_notify (G_OBJECT (fo_list_block), "border-top-width");*/
}
...
**/
FoProperty *
fo_list_block_get_break_after (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->break_after;
}
 ...
 **/
void
fo_list_block_set_break_after (FoFo *fo_fo,
		         FoProperty *new_break_after)
{
  ...
  if (fo_list_block->break_after != NULL)
    {
      g_object_unref (fo_list_block->break_after);
    }
  fo_list_block->break_after = new_break_after;
  /*g_object_notify (G_OBJECT (fo_list_block), "break-after");*/
}
...
**/
FoProperty *
fo_list_block_get_break_before (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->break_before;
}
 ...
 **/
void
fo_list_block_set_break_before (FoFo *fo_fo,
		         FoProperty *new_break_before)
{
  ...
  if (fo_list_block->break_before != NULL)
    {
      g_object_unref (fo_list_block->break_before);
    }
  fo_list_block->break_before = new_break_before;
  /*g_object_notify (G_OBJECT (fo_list_block), "break-before");*/
}
...
**/
FoProperty *
fo_list_block_get_end_indent (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->end_indent;
}
 ...
 **/
void
fo_list_block_set_end_indent (FoFo *fo_fo,
		         FoProperty *new_end_indent)
{
  ...
  if (fo_list_block->end_indent != NULL)
    {
      g_object_unref (fo_list_block->end_indent);
    }
  fo_list_block->end_indent = new_end_indent;
  /*g_object_notify (G_OBJECT (fo_list_block), "end-indent");*/
}
...
**/
FoProperty *
fo_list_block_get_id (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
 ...
 **/
void
fo_list_block_set_id (FoFo *fo_fo,
		         FoProperty *new_id)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  if (fo_list_block->id != NULL)
    {
      g_object_unref (fo_list_block->id);
    }
  fo_list_block->id = new_id;
  /*g_object_notify (G_OBJECT (fo_list_block), "id");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_together (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_together;
}
 ...
 **/
void
fo_list_block_set_keep_together (FoFo *fo_fo,
		         FoProperty *new_keep_together)
{
  ...
  if (fo_list_block->keep_together != NULL)
    {
      g_object_unref (fo_list_block->keep_together);
    }
  fo_list_block->keep_together = new_keep_together;
...
**/
FoProperty *
fo_list_block_get_keep_together_within_column (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_together_within_column;
}
 ...
 **/
void
fo_list_block_set_keep_together_within_column (FoFo *fo_fo,
		         FoProperty *new_keep_together_within_column)
{
  ...
  if (fo_list_block->keep_together_within_column != NULL)
    {
      g_object_unref (fo_list_block->keep_together_within_column);
    }
  fo_list_block->keep_together_within_column = new_keep_together_within_column;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-together-within-column");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_together_within_line (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_together_within_line;
}
 ...
 **/
void
fo_list_block_set_keep_together_within_line (FoFo *fo_fo,
		         FoProperty *new_keep_together_within_line)
{
  ...
  if (fo_list_block->keep_together_within_line != NULL)
    {
      g_object_unref (fo_list_block->keep_together_within_line);
    }
  fo_list_block->keep_together_within_line = new_keep_together_within_line;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-together-within-line");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_together_within_page (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_together_within_page;
}
 ...
 **/
void
fo_list_block_set_keep_together_within_page (FoFo *fo_fo,
		         FoProperty *new_keep_together_within_page)
{
  ...
  if (fo_list_block->keep_together_within_page != NULL)
    {
      g_object_unref (fo_list_block->keep_together_within_page);
    }
  fo_list_block->keep_together_within_page = new_keep_together_within_page;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-together-within-page");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_with_next (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_with_next;
}
 ...
 **/
void
fo_list_block_set_keep_with_next (FoFo *fo_fo,
		         FoProperty *new_keep_with_next)
{
  ...
  if (fo_list_block->keep_with_next != NULL)
    {
      g_object_unref (fo_list_block->keep_with_next);
    }
  fo_list_block->keep_with_next = new_keep_with_next;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-with-next");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_with_next_within_column (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_with_next_within_column;
}
 ...
 **/
void
fo_list_block_set_keep_with_next_within_column (FoFo *fo_fo,
		         FoProperty *new_keep_with_next_within_column)
{
  ...
  if (fo_list_block->keep_with_next_within_column != NULL)
    {
      g_object_unref (fo_list_block->keep_with_next_within_column);
    }
  fo_list_block->keep_with_next_within_column = new_keep_with_next_within_column;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-with-next-within-column");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_with_next_within_line (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_with_next_within_line;
}
 ...
 **/
void
fo_list_block_set_keep_with_next_within_line (FoFo *fo_fo,
		         FoProperty *new_keep_with_next_within_line)
{
  ...
  if (fo_list_block->keep_with_next_within_line != NULL)
    {
      g_object_unref (fo_list_block->keep_with_next_within_line);
    }
  fo_list_block->keep_with_next_within_line = new_keep_with_next_within_line;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-with-next-within-line");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_with_next_within_page (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_with_next_within_page;
}
 ...
 **/
void
fo_list_block_set_keep_with_next_within_page (FoFo *fo_fo,
		         FoProperty *new_keep_with_next_within_page)
{
  ...
  if (fo_list_block->keep_with_next_within_page != NULL)
    {
      g_object_unref (fo_list_block->keep_with_next_within_page);
    }
  fo_list_block->keep_with_next_within_page = new_keep_with_next_within_page;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-with-next-within-page");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_with_previous (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_with_previous;
}
 ...
 **/
void
fo_list_block_set_keep_with_previous (FoFo *fo_fo,
		         FoProperty *new_keep_with_previous)
{
  ...
  if (fo_list_block->keep_with_previous != NULL)
    {
      g_object_unref (fo_list_block->keep_with_previous);
    }
  fo_list_block->keep_with_previous = new_keep_with_previous;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-with-previous");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_with_previous_within_column (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_with_previous_within_column;
}
 ...
 **/
void
fo_list_block_set_keep_with_previous_within_column (FoFo *fo_fo,
		         FoProperty *new_keep_with_previous_within_column)
{
  ...
  if (fo_list_block->keep_with_previous_within_column != NULL)
    {
      g_object_unref (fo_list_block->keep_with_previous_within_column);
    }
  fo_list_block->keep_with_previous_within_column = new_keep_with_previous_within_column;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-with-previous-within-column");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_with_previous_within_line (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_with_previous_within_line;
}
 ...
 **/
void
fo_list_block_set_keep_with_previous_within_line (FoFo *fo_fo,
		         FoProperty *new_keep_with_previous_within_line)
{
  ...
  if (fo_list_block->keep_with_previous_within_line != NULL)
    {
      g_object_unref (fo_list_block->keep_with_previous_within_line);
    }
  fo_list_block->keep_with_previous_within_line = new_keep_with_previous_within_line;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-with-previous-within-line");*/
}
...
**/
FoProperty *
fo_list_block_get_keep_with_previous_within_page (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->keep_with_previous_within_page;
}
 ...
 **/
void
fo_list_block_set_keep_with_previous_within_page (FoFo *fo_fo,
		         FoProperty *new_keep_with_previous_within_page)
{
  ...
  if (fo_list_block->keep_with_previous_within_page != NULL)
    {
      g_object_unref (fo_list_block->keep_with_previous_within_page);
    }
  fo_list_block->keep_with_previous_within_page = new_keep_with_previous_within_page;
  /*g_object_notify (G_OBJECT (fo_list_block), "keep-with-previous-within-page");*/
}
...
**/
FoProperty *
fo_list_block_get_margin_bottom (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->margin_bottom;
}
 ...
 **/
void
fo_list_block_set_margin_bottom (FoFo *fo_fo,
		         FoProperty *new_margin_bottom)
{
  ...
  if (fo_list_block->margin_bottom != NULL)
    {
      g_object_unref (fo_list_block->margin_bottom);
    }
  fo_list_block->margin_bottom = new_margin_bottom;
  /*g_object_notify (G_OBJECT (fo_list_block), "margin-bottom");*/
}
...
**/
FoProperty *
fo_list_block_get_margin_left (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->margin_left;
}
 ...
 **/
void
fo_list_block_set_margin_left (FoFo *fo_fo,
		         FoProperty *new_margin_left)
{
  ...
  if (fo_list_block->margin_left != NULL)
    {
      g_object_unref (fo_list_block->margin_left);
    }
  fo_list_block->margin_left = new_margin_left;
  /*g_object_notify (G_OBJECT (fo_list_block), "margin-left");*/
}
...
**/
FoProperty *
fo_list_block_get_margin_right (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->margin_right;
}
 ...
 **/
void
fo_list_block_set_margin_right (FoFo *fo_fo,
		         FoProperty *new_margin_right)
{
  ...
  if (fo_list_block->margin_right != NULL)
    {
      g_object_unref (fo_list_block->margin_right);
    }
  fo_list_block->margin_right = new_margin_right;
  /*g_object_notify (G_OBJECT (fo_list_block), "margin-right");*/
}
...
**/
FoProperty *
fo_list_block_get_margin_top (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->margin_top;
}
 ...
 **/
void
fo_list_block_set_margin_top (FoFo *fo_fo,
		         FoProperty *new_margin_top)
{
  ...
  if (fo_list_block->margin_top != NULL)
    {
      g_object_unref (fo_list_block->margin_top);
    }
  fo_list_block->margin_top = new_margin_top;
  /*g_object_notify (G_OBJECT (fo_list_block), "margin-top");*/
}
...
**/
FoProperty *
fo_list_block_get_padding_after (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->padding_after;
}
 ...
 **/
void
fo_list_block_set_padding_after (FoFo *fo_fo,
		         FoProperty *new_padding_after)
{
  ...
  if (fo_list_block->padding_after != NULL)
    {
      g_object_unref (fo_list_block->padding_after);
    }
  fo_list_block->padding_after = new_padding_after;
  /*g_object_notify (G_OBJECT (fo_list_block), "padding-after");*/
}
...
**/
FoProperty *
fo_list_block_get_padding_before (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->padding_before;
}
 ...
 **/
void
fo_list_block_set_padding_before (FoFo *fo_fo,
		         FoProperty *new_padding_before)
{
  ...
  if (fo_list_block->padding_before != NULL)
    {
      g_object_unref (fo_list_block->padding_before);
    }
  fo_list_block->padding_before = new_padding_before;
  /*g_object_notify (G_OBJECT (fo_list_block), "padding-before");*/
}
...
**/
FoProperty *
fo_list_block_get_padding_bottom (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->padding_bottom;
}
 ...
 **/
void
fo_list_block_set_padding_bottom (FoFo *fo_fo,
		         FoProperty *new_padding_bottom)
{
  ...
  if (fo_list_block->padding_bottom != NULL)
    {
      g_object_unref (fo_list_block->padding_bottom);
    }
  fo_list_block->padding_bottom = new_padding_bottom;
  /*g_object_notify (G_OBJECT (fo_list_block), "padding-bottom");*/
}
...
**/
FoProperty *
fo_list_block_get_padding_end (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->padding_end;
}
 ...
 **/
void
fo_list_block_set_padding_end (FoFo *fo_fo,
		         FoProperty *new_padding_end)
{
  ...
  if (fo_list_block->padding_end != NULL)
    {
      g_object_unref (fo_list_block->padding_end);
    }
  fo_list_block->padding_end = new_padding_end;
  /*g_object_notify (G_OBJECT (fo_list_block), "padding-end");*/
}
...
**/
FoProperty *
fo_list_block_get_padding_left (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->padding_left;
}
 ...
 **/
void
fo_list_block_set_padding_left (FoFo *fo_fo,
		         FoProperty *new_padding_left)
{
  ...
  if (fo_list_block->padding_left != NULL)
    {
      g_object_unref (fo_list_block->padding_left);
    }
  fo_list_block->padding_left = new_padding_left;
  /*g_object_notify (G_OBJECT (fo_list_block), "padding-left");*/
}
...
**/
FoProperty *
fo_list_block_get_padding_right (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->padding_right;
}
 ...
 **/
void
fo_list_block_set_padding_right (FoFo *fo_fo,
		         FoProperty *new_padding_right)
{
  ...
  if (fo_list_block->padding_right != NULL)
    {
      g_object_unref (fo_list_block->padding_right);
    }
  fo_list_block->padding_right = new_padding_right;
  /*g_object_notify (G_OBJECT (fo_list_block), "padding-right");*/
}
...
**/
FoProperty *
fo_list_block_get_padding_start (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->padding_start;
}
 ...
 **/
void
fo_list_block_set_padding_start (FoFo *fo_fo,
		         FoProperty *new_padding_start)
{
  ...
  if (fo_list_block->padding_start != NULL)
    {
      g_object_unref (fo_list_block->padding_start);
    }
  fo_list_block->padding_start = new_padding_start;
  /*g_object_notify (G_OBJECT (fo_list_block), "padding-start");*/
}
...
**/
FoProperty *
fo_list_block_get_padding_top (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->padding_top;
}
 ...
 **/
void
fo_list_block_set_padding_top (FoFo *fo_fo,
		         FoProperty *new_padding_top)
{
  ...
  if (fo_list_block->padding_top != NULL)
    {
      g_object_unref (fo_list_block->padding_top);
    }
  fo_list_block->padding_top = new_padding_top;
  /*g_object_notify (G_OBJECT (fo_list_block), "padding-top");*/
}
...
**/
FoProperty *
fo_list_block_get_provisional_distance_between_starts (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->provisional_distance_between_starts;
}
 ...
 **/
void
fo_list_block_set_provisional_distance_between_starts (FoFo *fo_fo,
		         FoProperty *new_provisional_distance_between_starts)
{
  ...
  if (fo_list_block->provisional_distance_between_starts != NULL)
    {
      g_object_unref (fo_list_block->provisional_distance_between_starts);
    }
  fo_list_block->provisional_distance_between_starts = new_provisional_distance_between_starts;
  /*g_object_notify (G_OBJECT (fo_list_block), "provisional-distance-between-starts");*/
}
...
**/
FoProperty *
fo_list_block_get_provisional_label_separation (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->provisional_label_separation;
}
 ...
 **/
void
fo_list_block_set_provisional_label_separation (FoFo *fo_fo,
		         FoProperty *new_provisional_label_separation)
{
  ...
  if (fo_list_block->provisional_label_separation != NULL)
    {
      g_object_unref (fo_list_block->provisional_label_separation);
    }
  fo_list_block->provisional_label_separation = new_provisional_label_separation;
  /*g_object_notify (G_OBJECT (fo_list_block), "provisional-label-separation");*/
}
...
**/
FoProperty *
fo_list_block_get_role (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
 ...
 **/
void
fo_list_block_set_role (FoFo *fo_fo,
		         FoProperty *new_role)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  if (fo_list_block->role != NULL)
    {
      g_object_unref (fo_list_block->role);
    }
  fo_list_block->role = new_role;
  /*g_object_notify (G_OBJECT (fo_list_block), "role");*/
}
...
**/
FoProperty *
fo_list_block_get_source_document (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->source_document;
}
 ...
 **/
void
fo_list_block_set_source_document (FoFo *fo_fo,
		         FoProperty *new_source_document)
{
  ...
  if (fo_list_block->source_document != NULL)
    {
      g_object_unref (fo_list_block->source_document);
    }
  fo_list_block->source_document = new_source_document;
  /*g_object_notify (G_OBJECT (fo_list_block), "source-document");*/
}
...
**/
FoProperty *
fo_list_block_get_space_after (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->space_after;
}
 ...
 **/
void
fo_list_block_set_space_after (FoFo *fo_fo,
		         FoProperty *new_space_after)
{
  ...
  if (fo_list_block->space_after != NULL)
    {
      g_object_unref (fo_list_block->space_after);
    }
  fo_list_block->space_after = new_space_after;
  /*g_object_notify (G_OBJECT (fo_list_block), "space-after");*/
}
...
**/
FoProperty *
fo_list_block_get_space_before (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->space_before;
}
 ...
 **/
void
fo_list_block_set_space_before (FoFo *fo_fo,
		         FoProperty *new_space_before)
{
  ...
  if (fo_list_block->space_before != NULL)
    {
      g_object_unref (fo_list_block->space_before);
    }
  fo_list_block->space_before = new_space_before;
  /*g_object_notify (G_OBJECT (fo_list_block), "space-before");*/
}
...
**/
FoProperty *
fo_list_block_get_start_indent (FoFo *fo_fo)
{
  FoListBlock *fo_list_block = (FoListBlock *) fo_fo;
  ...
  return fo_list_block->start_indent;
}
 ...
 **/
void
fo_list_block_set_start_indent (FoFo *fo_fo,
		         FoProperty *new_start_indent)
{
  ...
  if (fo_list_block->start_indent != NULL)
    {
      g_object_unref (fo_list_block->start_indent);
    }
  fo_list_block->start_indent = new_start_indent;
  /*g_object_notify (G_OBJECT (fo_list_block), "start-indent");*/
}
