 ...
 * 
 * Default 'update_from_context' function.  Set as the default for
 ...
 * @context: #FoContext from which to update the #FoFo
 * 
 * Calls the #FoFo-specific 'update_from_context' function to update
 ...
 * @fo:       #FoFo that (hopefully) generated @new_area
 * @sibling:  #FoArea after which to insert @new_area
 * @new_area: New area to insert into area list for @fo
 *
