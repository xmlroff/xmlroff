...
_dispose (GObject *object)
{
  ...
  fo_context_set_alignment_adjust (context, NULL);
  fo_context_set_alignment_baseline (context, NULL);
  ...
  fo_context_set_border (context, NULL);
  fo_context_set_border_after_color (context, NULL);
  fo_context_set_border_after_precedence (context, NULL);
  fo_context_set_border_after_style (context, NULL);
  fo_context_set_border_after_width (context, NULL);
  fo_context_set_border_before_color (context, NULL);
  fo_context_set_border_before_precedence (context, NULL);
  fo_context_set_border_before_style (context, NULL);
  fo_context_set_border_before_width (context, NULL);
  fo_context_set_border_bottom (context, NULL);
  fo_context_set_border_bottom_color (context, NULL);
  fo_context_set_border_bottom_style (context, NULL);
  fo_context_set_border_bottom_width (context, NULL);
  fo_context_set_border_collapse (context, NULL);
  fo_context_set_border_color (context, NULL);
  fo_context_set_border_end_color (context, NULL);
  fo_context_set_border_end_precedence (context, NULL);
  fo_context_set_border_end_style (context, NULL);
  fo_context_set_border_end_width (context, NULL);
  fo_context_set_border_left (context, NULL);
  fo_context_set_border_left_color (context, NULL);
  fo_context_set_border_left_style (context, NULL);
  fo_context_set_border_left_width (context, NULL);
  fo_context_set_border_right (context, NULL);
  fo_context_set_border_right_color (context, NULL);
  fo_context_set_border_right_style (context, NULL);
  fo_context_set_border_right_width (context, NULL);
  fo_context_set_border_separation (context, NULL);
  fo_context_set_border_start_color (context, NULL);
  fo_context_set_border_start_precedence (context, NULL);
  fo_context_set_border_start_style (context, NULL);
  fo_context_set_border_start_width (context, NULL);
  fo_context_set_border_style (context, NULL);
  fo_context_set_border_top (context, NULL);
  fo_context_set_border_top_color (context, NULL);
  fo_context_set_border_top_style (context, NULL);
  fo_context_set_border_top_width (context, NULL);
  fo_context_set_border_width (context, NULL);
  fo_context_set_break_after (context, NULL);
  fo_context_set_break_before (context, NULL);
  fo_context_set_character (context, NULL);
  fo_context_set_clip (context, NULL);
  fo_context_set_color (context, NULL);
  fo_context_set_column_number (context, NULL);
  fo_context_set_column_width (context, NULL);
  ...
  fo_context_set_end_indent (context, NULL);
  fo_context_set_extent (context, NULL);
  fo_context_set_flow_name (context, NULL);
  fo_context_set_font_family (context, NULL);
  fo_context_set_font_size (context, NULL);
  fo_context_set_font_stretch (context, NULL);
  ...
  fo_context_set_keep_together (context, NULL);
  fo_context_set_keep_together_within_column (context, NULL);
  fo_context_set_keep_together_within_line (context, NULL);
  fo_context_set_keep_together_within_page (context, NULL);
  fo_context_set_keep_with_next (context, NULL);
  fo_context_set_keep_with_next_within_column (context, NULL);
  fo_context_set_keep_with_next_within_line (context, NULL);
  fo_context_set_keep_with_next_within_page (context, NULL);
  fo_context_set_keep_with_previous (context, NULL);
  ...
  fo_context_set_linefeed_treatment (context, NULL);
  fo_context_set_margin (context, NULL);
  fo_context_set_margin_bottom (context, NULL);
  fo_context_set_margin_left (context, NULL);
  fo_context_set_margin_right (context, NULL);
  ...
  fo_context_set_padding_after (context, NULL);
  fo_context_set_padding_after_length (context, NULL);
  fo_context_set_padding_after_condity (context, NULL);
  fo_context_set_padding_before (context, NULL);
  fo_context_set_padding_before_length (context, NULL);
  fo_context_set_padding_before_condity (context, NULL);
  fo_context_set_padding_bottom (context, NULL);
  fo_context_set_padding_end (context, NULL);
  fo_context_set_padding_end_length (context, NULL);
  fo_context_set_padding_end_condity (context, NULL);
  fo_context_set_padding_left (context, NULL);
  fo_context_set_padding_right (context, NULL);
  fo_context_set_padding_start (context, NULL);
  fo_context_set_padding_start_length (context, NULL);
  ...
  fo_context_set_scaling_method (context, NULL);
  fo_context_set_score_spaces (context, NULL);
  fo_context_set_source_document (context, NULL);
  ...
  fo_context_set_space_end_minimum (context, NULL);
  fo_context_set_space_end_optimum (context, NULL);
  fo_context_set_space_end_maximum (context, NULL);
  fo_context_set_space_end_precedence (context, NULL);
  fo_context_set_space_end_condity (context, NULL);
  fo_context_set_space_start (context, NULL);
  fo_context_set_space_start_minimum (context, NULL);
  fo_context_set_space_start_optimum (context, NULL);
  fo_context_set_space_start_maximum (context, NULL);
  fo_context_set_space_start_precedence (context, NULL);
  fo_context_set_space_start_condity (context, NULL);
  fo_context_set_span (context, NULL);
  fo_context_set_src (context, NULL);
  fo_context_set_start_indent (context, NULL);
  fo_context_set_table_layout (context, NULL);
  fo_context_set_text_align (context, NULL);
  fo_context_set_text_indent (context, NULL);
  fo_context_set_unicode_bidi (context, NULL);
  fo_context_set_white_space_collapse (context, NULL);
  fo_context_set_white_space_treatment (context, NULL);
  fo_context_set_widows (context, NULL);
  fo_context_set_width (context, NULL);
