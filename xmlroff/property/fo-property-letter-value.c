 ...
 *
 * $Id: fo-property-letter-value.c,v 1.4 2004/03/24 12:28:36 tonygraham Exp $
 *
...
struct _FoPropertyLetterValueClass
{
 ...
 * 
 * Register the #FoPropertyLetterValue type if not already registered and
 * return its #GType value.
 * 
 * Return value: #GType of #FoPropertyLetterValue.
 **/
GType
fo_property_letter_value_get_type (void)
{
 ...
 * 
 * Return value: the new #FoPropertyLetterValue.
 **/
FoProperty*
fo_property_letter_value_new (void)
{
  ...
  letter_value =
    FO_PROPERTY (g_object_new (fo_property_letter_value_get_type (),
                               NULL));
...
{
  static FoProperty *letter_value = NULL;
