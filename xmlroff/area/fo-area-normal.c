/* Fo
 * fo-area-normal.c: Normal block-area object
 *
 * Copyright (C) 2001 Sun Microsystems
 *
 * $Id: fo-area-normal.c,v 1.2 2003/03/19 21:12:42 tonygraham Exp $
 *
...
struct _FoAreaNormal
{
  FoAreaArea parent_instance;
};

struct _FoAreaNormalClass
{
  FoAreaAreaClass parent_class;
};

static void fo_area_normal_class_init  (FoAreaNormalClass *klass);
static void fo_area_normal_finalize    (GObject           *object);

static void fo_area_normal_debug_dump_properties (FoArea *area,
							      gint depth);
static FoArea* fo_area_normal_size_request (FoArea *child);

static gpointer parent_class;

GType
fo_area_normal_get_type (void)
{
  ...
  if (!object_type)
    {
      ...
      {
        sizeof (FoAreaNormalClass),
        (GBaseInitFunc) NULL,
        (GBaseFinalizeFunc) NULL,
        (GClassInitFunc) fo_area_normal_class_init,
        NULL,           /* class_finalize */
        NULL,           /* class_data */
        sizeof (FoAreaNormal),
        0,              /* n_preallocs */
...
static void
fo_area_normal_class_init (FoAreaNormalClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);

  parent_class = g_type_class_peek_parent (klass);
  
  object_class->finalize = fo_area_normal_finalize;

  FO_AREA_CLASS (klass)->debug_dump_properties = fo_area_normal_debug_dump_properties;
  FO_AREA_CLASS (klass)->size_request = fo_area_normal_size_request;
}

static void
fo_area_normal_finalize (GObject *object)
{
  FoAreaNormal *fo_area_normal;

  fo_area_normal = FO_AREA_NORMAL (object);
 ...
 * 
 * Return value: the new #FoAreaNormal
 **/
FoArea*
fo_area_normal_new (void)
{
  return FO_AREA (g_object_new (fo_area_normal_get_type (), NULL));
}


void
fo_area_normal_debug_dump_properties (FoArea *area, gint depth)
{
  FoAreaNormal *normal;
  gchar *indent = g_strnfill (depth * 2, ' ');

  g_return_if_fail (area != NULL);
  g_return_if_fail (FO_IS_AREA_NORMAL (area));

  normal = FO_AREA_NORMAL (area);
...
FoArea*
fo_area_normal_add_child (FoArea *parent, FoArea *child)
{
  g_return_val_if_fail (parent != NULL, NULL);
  g_return_val_if_fail (FO_IS_AREA_NORMAL (parent), NULL);
 ...
 **/
FoArea*
fo_area_normal_size_request (FoArea *child)
{
  FoArea *use_child_area;
  FoArea *parent;
  gfloat total_child_height = 0;
  gfloat normal_child_available_bpdim;
  gfloat child_height;
  ...
  normal_child_available_bpdim = fo_area_get_child_available_bpdim (parent);

#if defined(LIBFO_DEBUG) && 0
  g_message ("normal_size_request (%p):: parent: %s; generated by: %s; available_height: %f",
	     child,
	     fo_object_debug_sprintf (parent),
	     fo_object_debug_sprintf (parent->generated_by),
	     normal_child_available_bpdim);
  g_message ("normal_size_request (%p):: child: %s; generated by: %s; height: %f; space_before: %f; space_after: %f",
	     child,
  ...
  fo_area_children_foreach (parent,
			    ...
			    &total_child_height);
#if defined(LIBFO_DEBUG) && 0
  g_message ("normal_size_request (%p):: child total: %f",
	     child,
	     total_child_height);
#endif
  ...
  /* Don't bother doing a size_request if still fit within
     available height */
  if (normal_child_available_bpdim < fo_area_area_get_height (parent))
  {
    ...
    fo_area_set_child_available_bpdim (parent,
				       normal_child_available_bpdim);
#if defined(LIBFO_DEBUG) && 0
    g_message ("normal_size_request (%p):: new parent: %s; generated by: %s; available_height: %f",
	       child,
	       fo_object_debug_sprintf (parent),
	       fo_object_debug_sprintf (parent->generated_by),
	       normal_child_available_bpdim);
...
#if defined(LIBFO_DEBUG) && 0
  g_message ("normal_size_request (%p):: new child total: %f",
	     child,
	     total_child_height);
#endif
  ...
  if (total_child_height <= normal_child_available_bpdim)
    {
...
#if defined(LIBFO_DEBUG) && 0
      g_message ("normal_size_request (%p):: return:: parent->last: %s; generated by: %s",
		 child,
  ...
  else
    {
      ...
      while (use_child_area)
	{
	  if (normal_child_available_bpdim >=
	      fo_area_area_get_height (use_child_area))
	    {
	      fo_area_area_set_x (use_child_area,
				  fo_area_get_next_x (parent) +
	  ...
	  else
	    {
	      ...
	      g_message ("normal_size_request:: splitting:: child: %s; generated by: %s",
...
#if defined(LIBFO_DEBUG) && 0
      g_message ("normal_size_request (%p):: total > available:: return:: parent->last: %s; generated by: %s",
		 child,
		 fo_object_debug_sprintf (fo_area_last_child (parent)),
		 fo_object_debug_sprintf (fo_area_last_child (parent->generated_by)));
#endif
