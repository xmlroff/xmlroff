 ...
 *
 * $Id: fo-table-row.c,v 1.4 2004/03/30 22:45:43 tonygraham Exp $
 *
...
fo_table_row_class_init (FoTableRowClass *klass)
{
  ...
  fofo_class->validate_content = fo_table_row_validate_content;
  fofo_class->validate2 = fo_table_row_validate;
  ...
  fofo_class->area_new2 = fo_table_row_area_new2;
...
fo_table_row_finalize (GObject *object)
{
  ...
  fo_table_row = FO_TABLE_ROW (object);
 ...
 **/
void
fo_table_row_debug_dump_properties (FoFo *fo, gint depth)
{
  FoTableRow *fo_table_row;
