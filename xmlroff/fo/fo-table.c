 ...
 *
 * $Id: fo-table.c,v 1.15 2005/12/06 11:07:30 tonygraham Exp $
 *
...
fo_table_class_init (FoTableClass *klass)
{
  ...
  fofo_class->validate_content = fo_table_validate_content;
  fofo_class->validate2 = fo_table_validate;
  ...
  fofo_class->area_new2 = fo_table_area_new2;
...
fo_table_error_quark (void)
{
  ...
  if (quark == 0)
    quark = g_quark_from_static_string ("fo-table");
  return quark;
}
 ...
 **/
void
fo_table_debug_dump_properties (FoFo *fo, gint depth)
{
  FoTable *fo_table;
  gchar *indent = g_strnfill (depth * 2, ' ');
		         ...
		         FoProperty *new_border_collapse)
{
  ...
  g_return_if_fail (fo_table != NULL);
  g_return_if_fail (FO_IS_TABLE (fo_table));
  g_return_if_fail (FO_IS_PROPERTY_BORDER_COLLAPSE (new_border_collapse));
		         ...
		         FoProperty *new_border_separation)
{
  ...
  g_return_if_fail (fo_table != NULL);
  g_return_if_fail (FO_IS_TABLE (fo_table));
  g_return_if_fail (FO_IS_PROPERTY_BORDER_SEPARATION (new_border_separation));
		         ...
		         FoProperty *new_table_layout)
{
  ...
  g_return_if_fail (fo_table != NULL);
  g_return_if_fail (FO_IS_TABLE (fo_table));
  g_return_if_fail (FO_IS_PROPERTY_TABLE_LAYOUT (new_table_layout));
