/* Fo
 * fo-page_number.h: 'page-number' formatting object
 *
 * Copyright (C) 2001 Sun Microsystems
 *
 * $Id: fo-page-number.h,v 1.4 2004/03/30 22:45:42 tonygraham Exp $
 *
 * See Copying for the status of this software.
 */

#ifndef __FO_PAGE_NUMBER_H__
#define __FO_PAGE_NUMBER_H__
...
#define FO_TYPE_PAGE_NUMBER              (fo_page_number_get_type ())
#define FO_PAGE_NUMBER(object)           (G_TYPE_CHECK_INSTANCE_CAST ((object), FO_TYPE_PAGE_NUMBER, FoPageNumber))
#define FO_PAGE_NUMBER_CLASS(klass)      (G_TYPE_CHECK_CLASS_CAST ((klass), FO_TYPE_PAGE_NUMBER, FoPageNumberClass))
#define FO_IS_PAGE_NUMBER(object)        (G_TYPE_CHECK_INSTANCE_TYPE ((object), FO_TYPE_PAGE_NUMBER))
#define FO_IS_PAGE_NUMBER_CLASS(klass)   (G_TYPE_CHECK_CLASS_TYPE ((klass), FO_TYPE_PAGE_NUMBER))
#define FO_PAGE_NUMBER_GET_CLASS(obj)    (G_TYPE_INSTANCE_GET_CLASS ((obj), FO_TYPE_PAGE_NUMBER, FoPageNumberClass))


GType        fo_page_number_get_type      (void) G_GNUC_CONST;
...
FoProperty * fo_page_number_get_alignment_baseline (FoFo       *fo_fo);
void         fo_page_number_set_alignment_baseline (FoFo       *fo_fo,
...
FoProperty * fo_page_number_get_border_after_color (FoFo       *fo_fo);
void         fo_page_number_set_border_after_color (FoFo       *fo_fo,
                                                    FoProperty *new_border_after_color);
FoProperty * fo_page_number_get_border_after_style (FoFo       *fo_fo);
void         fo_page_number_set_border_after_style (FoFo       *fo_fo,
                                                    FoProperty *new_border_after_style);
FoProperty * fo_page_number_get_border_after_width (FoFo       *fo_fo);
void         fo_page_number_set_border_after_width (FoFo       *fo_fo,
                                                    FoProperty *new_border_after_width);
FoProperty * fo_page_number_get_border_before_color (FoFo       *fo_fo);
void         fo_page_number_set_border_before_color (FoFo       *fo_fo,
                                                     FoProperty *new_border_before_color);
FoProperty * fo_page_number_get_border_before_style (FoFo       *fo_fo);
void         fo_page_number_set_border_before_style (FoFo       *fo_fo,
                                                     FoProperty *new_border_before_style);
FoProperty * fo_page_number_get_border_before_width (FoFo       *fo_fo);
void         fo_page_number_set_border_before_width (FoFo       *fo_fo,
                                                     FoProperty *new_border_before_width);
FoProperty * fo_page_number_get_border_bottom_color (FoFo       *fo_fo);
void         fo_page_number_set_border_bottom_color (FoFo       *fo_fo,
                                                     FoProperty *new_border_bottom_color);
FoProperty * fo_page_number_get_border_bottom_style (FoFo       *fo_fo);
void         fo_page_number_set_border_bottom_style (FoFo       *fo_fo,
                                                     FoProperty *new_border_bottom_style);
FoProperty * fo_page_number_get_border_bottom_width (FoFo       *fo_fo);
void         fo_page_number_set_border_bottom_width (FoFo       *fo_fo,
...
FoProperty * fo_page_number_get_border_left_color (FoFo       *fo_fo);
void         fo_page_number_set_border_left_color (FoFo       *fo_fo,
                                                   FoProperty *new_border_left_color);
FoProperty * fo_page_number_get_border_left_style (FoFo       *fo_fo);
void         fo_page_number_set_border_left_style (FoFo       *fo_fo,
                                                   FoProperty *new_border_left_style);
FoProperty * fo_page_number_get_border_left_width (FoFo       *fo_fo);
void         fo_page_number_set_border_left_width (FoFo       *fo_fo,
                                                   FoProperty *new_border_left_width);
FoProperty * fo_page_number_get_border_right_color (FoFo       *fo_fo);
void         fo_page_number_set_border_right_color (FoFo       *fo_fo,
                                                    FoProperty *new_border_right_color);
FoProperty * fo_page_number_get_border_right_style (FoFo       *fo_fo);
void         fo_page_number_set_border_right_style (FoFo       *fo_fo,
                                                    FoProperty *new_border_right_style);
FoProperty * fo_page_number_get_border_right_width (FoFo       *fo_fo);
void         fo_page_number_set_border_right_width (FoFo       *fo_fo,
                                                    FoProperty *new_border_right_width);
FoProperty * fo_page_number_get_border_start_color (FoFo       *fo_fo);
void         fo_page_number_set_border_start_color (FoFo       *fo_fo,
                                                    FoProperty *new_border_start_color);
FoProperty * fo_page_number_get_border_start_style (FoFo       *fo_fo);
void         fo_page_number_set_border_start_style (FoFo       *fo_fo,
                                                    FoProperty *new_border_start_style);
FoProperty * fo_page_number_get_border_start_width (FoFo       *fo_fo);
void         fo_page_number_set_border_start_width (FoFo       *fo_fo,
...
FoProperty * fo_page_number_get_dominant_baseline (FoFo       *fo_fo);
void         fo_page_number_set_dominant_baseline (FoFo       *fo_fo,
...
FoProperty * fo_page_number_get_keep_with_next_within_column (FoFo       *fo_fo);
void         fo_page_number_set_keep_with_next_within_column (FoFo       *fo_fo,
                                                              FoProperty *new_keep_with_next_within_column);
FoProperty * fo_page_number_get_keep_with_next_within_line (FoFo       *fo_fo);
void         fo_page_number_set_keep_with_next_within_line (FoFo       *fo_fo,
                                                            FoProperty *new_keep_with_next_within_line);
FoProperty * fo_page_number_get_keep_with_next_within_page (FoFo       *fo_fo);
void         fo_page_number_set_keep_with_next_within_page (FoFo       *fo_fo,
                                                            FoProperty *new_keep_with_next_within_page);
FoProperty * fo_page_number_get_keep_with_previous (FoFo       *fo_fo);
void         fo_page_number_set_keep_with_previous (FoFo       *fo_fo,
                                                    FoProperty *new_keep_with_previous);
FoProperty * fo_page_number_get_keep_with_previous_within_column (FoFo       *fo_fo);
void         fo_page_number_set_keep_with_previous_within_column (FoFo       *fo_fo,
                                                                  FoProperty *new_keep_with_previous_within_column);
FoProperty * fo_page_number_get_keep_with_previous_within_line (FoFo       *fo_fo);
void         fo_page_number_set_keep_with_previous_within_line (FoFo       *fo_fo,
                                                                FoProperty *new_keep_with_previous_within_line);
FoProperty * fo_page_number_get_keep_with_previous_within_page (FoFo       *fo_fo);
void         fo_page_number_set_keep_with_previous_within_page (FoFo       *fo_fo,
