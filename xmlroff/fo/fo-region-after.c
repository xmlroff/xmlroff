 ...
 *
 * $Id: fo-region-after.c,v 1.8 2006/01/16 11:54:45 tonygraham Exp $
 *
...
static void fo_region_after_class_init  (FoRegionAfterClass *klass);
static void fo_region_after_get_property (GObject      *object,
                                          guint         prop_id,
                                          GValue       *value,
                                          GParamSpec   *pspec);
static void fo_region_after_set_property (GObject      *object,
                                          guint         prop_id,
                                          const GValue *value,
                                          GParamSpec   *pspec);
static void fo_region_after_finalize    (GObject           *object);
static void fo_region_after_validate (FoFo      *fo,
                                      FoContext *current_context,
                                      FoContext *parent_context,
                                      GError   **error);
static void fo_region_after_update_from_context (FoFo      *fo,
                                                 FoContext *context);
static void fo_region_after_debug_dump_properties (FoFo *fo,
                                                   gint  depth);
  ...
  if (!object_type)
    {
      static const GTypeInfo object_info =
      {
        ...
        NULL,           /* base_init */
        NULL,           /* base_finalize */
        (GClassInitFunc) fo_region_after_class_init,
        NULL,           /* class_finalize */
        NULL,           /* class_data */
...
fo_region_after_class_init (FoRegionAfterClass *klass)
{
  ...
  object_class->finalize = fo_region_after_finalize;
...
/**
 * fo_region_after_finalize:
 * @object: #FoRegionAfter object to finalize.
 * 
 * Implements #GObjectFinalizeFunc for #FoRegionAfter.
 **/
void
fo_region_after_finalize (GObject *object)
{
  FoRegionAfter *fo_region_after;

  fo_region_after = FO_REGION_AFTER (object);

  G_OBJECT_CLASS (parent_class)->finalize (object);
}

/**
 * fo_region_after_get_property:
 * @object:  #GObject whose property will be retrieved.
 * @prop_id: Property ID assigned when property registered.
 * @value:   GValue to set with property value.
 * @pspec:   Parameter specification for this property type.
 * 
 * Implements #GObjectGetPropertyFunc for #FoRegionAfter.
 **/
void
fo_region_after_get_property (GObject    *object,
                              guint       prop_id,
                              GValue     *value,
                              GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_BACKGROUND_COLOR:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_background_color (fo_fo)));
      break;
    case PROP_BACKGROUND_IMAGE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_background_image (fo_fo)));
      break;
    case PROP_BORDER_AFTER_COLOR:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_after_color (fo_fo)));
      break;
    case PROP_BORDER_AFTER_STYLE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_after_style (fo_fo)));
      break;
    case PROP_BORDER_AFTER_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_after_width (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_COLOR:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_before_color (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_STYLE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_before_style (fo_fo)));
      break;
    case PROP_BORDER_BEFORE_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_before_width (fo_fo)));
      break;
    case PROP_BORDER_BOTTOM_COLOR:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_bottom_color (fo_fo)));
      break;
    case PROP_BORDER_BOTTOM_STYLE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_bottom_style (fo_fo)));
      break;
    case PROP_BORDER_BOTTOM_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_bottom_width (fo_fo)));
      break;
    case PROP_BORDER_END_COLOR:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_end_color (fo_fo)));
      break;
    case PROP_BORDER_END_STYLE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_end_style (fo_fo)));
      break;
    case PROP_BORDER_END_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_end_width (fo_fo)));
      break;
    case PROP_BORDER_LEFT_COLOR:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_left_color (fo_fo)));
      break;
    case PROP_BORDER_LEFT_STYLE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_left_style (fo_fo)));
      break;
    case PROP_BORDER_LEFT_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_left_width (fo_fo)));
      break;
    case PROP_BORDER_RIGHT_COLOR:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_right_color (fo_fo)));
      break;
    case PROP_BORDER_RIGHT_STYLE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_right_style (fo_fo)));
      break;
    case PROP_BORDER_RIGHT_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_right_width (fo_fo)));
      break;
    case PROP_BORDER_START_COLOR:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_start_color (fo_fo)));
      break;
    case PROP_BORDER_START_STYLE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_start_style (fo_fo)));
      break;
    case PROP_BORDER_START_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_start_width (fo_fo)));
      break;
    case PROP_BORDER_TOP_COLOR:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_top_color (fo_fo)));
      break;
    case PROP_BORDER_TOP_STYLE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_top_style (fo_fo)));
      break;
    case PROP_BORDER_TOP_WIDTH:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_border_top_width (fo_fo)));
      break;
    case PROP_CLIP:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_clip (fo_fo)));
      break;
    case PROP_DISPLAY_ALIGN:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_display_align (fo_fo)));
      break;
    case PROP_EXTENT:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_extent (fo_fo)));
      break;
    case PROP_OVERFLOW:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_overflow (fo_fo)));
      break;
    case PROP_PADDING_AFTER:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_padding_after (fo_fo)));
      break;
    case PROP_PADDING_BEFORE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_padding_before (fo_fo)));
      break;
    case PROP_PADDING_BOTTOM:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_padding_bottom (fo_fo)));
      break;
    case PROP_PADDING_END:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_padding_end (fo_fo)));
      break;
    case PROP_PADDING_LEFT:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_padding_left (fo_fo)));
      break;
    case PROP_PADDING_RIGHT:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_padding_right (fo_fo)));
      break;
    case PROP_PADDING_START:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_padding_start (fo_fo)));
      break;
    case PROP_PADDING_TOP:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_padding_top (fo_fo)));
      break;
    case PROP_REGION_NAME:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_region_name (fo_fo)));
      break;
    case PROP_WRITING_MODE:
      g_value_set_object (value, G_OBJECT (fo_region_after_get_writing_mode (fo_fo)));
      break;
    default:
...
/**
 * fo_region_after_set_property:
 * @object:  #GObject whose property will be set.
 * @prop_id: Property ID assigned when property registered.
 * @value:   New value for property.
 * @pspec:   Parameter specification for this property type.
 * 
 * Implements #GObjectSetPropertyFunc for #FoRegionAfter.
 **/
void
fo_region_after_set_property (GObject      *object,
                              guint         prop_id,
                              const GValue *value,
                              GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_BACKGROUND_COLOR:
      fo_region_after_set_background_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BACKGROUND_IMAGE:
      fo_region_after_set_background_image (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_COLOR:
      fo_region_after_set_border_after_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_STYLE:
      fo_region_after_set_border_after_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_AFTER_WIDTH:
      fo_region_after_set_border_after_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_COLOR:
      fo_region_after_set_border_before_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_STYLE:
      fo_region_after_set_border_before_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BEFORE_WIDTH:
      fo_region_after_set_border_before_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BOTTOM_COLOR:
      fo_region_after_set_border_bottom_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BOTTOM_STYLE:
      fo_region_after_set_border_bottom_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_BOTTOM_WIDTH:
      fo_region_after_set_border_bottom_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_COLOR:
      fo_region_after_set_border_end_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_STYLE:
      fo_region_after_set_border_end_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_END_WIDTH:
      fo_region_after_set_border_end_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_LEFT_COLOR:
      fo_region_after_set_border_left_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_LEFT_STYLE:
      fo_region_after_set_border_left_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_LEFT_WIDTH:
      fo_region_after_set_border_left_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_RIGHT_COLOR:
      fo_region_after_set_border_right_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_RIGHT_STYLE:
      fo_region_after_set_border_right_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_RIGHT_WIDTH:
      fo_region_after_set_border_right_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_COLOR:
      fo_region_after_set_border_start_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_STYLE:
      fo_region_after_set_border_start_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_START_WIDTH:
      fo_region_after_set_border_start_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_TOP_COLOR:
      fo_region_after_set_border_top_color (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_TOP_STYLE:
      fo_region_after_set_border_top_style (fo_fo, g_value_get_object (value));
      break;
    case PROP_BORDER_TOP_WIDTH:
      fo_region_after_set_border_top_width (fo_fo, g_value_get_object (value));
      break;
    case PROP_CLIP:
      fo_region_after_set_clip (fo_fo, g_value_get_object (value));
      break;
    case PROP_DISPLAY_ALIGN:
      fo_region_after_set_display_align (fo_fo, g_value_get_object (value));
      break;
    case PROP_EXTENT:
      fo_region_after_set_extent (fo_fo, g_value_get_object (value));
      break;
    case PROP_OVERFLOW:
      fo_region_after_set_overflow (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_AFTER:
      fo_region_after_set_padding_after (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_BEFORE:
      fo_region_after_set_padding_before (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_BOTTOM:
      fo_region_after_set_padding_bottom (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_END:
      fo_region_after_set_padding_end (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_LEFT:
      fo_region_after_set_padding_left (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_RIGHT:
      fo_region_after_set_padding_right (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_START:
      fo_region_after_set_padding_start (fo_fo, g_value_get_object (value));
      break;
    case PROP_PADDING_TOP:
      fo_region_after_set_padding_top (fo_fo, g_value_get_object (value));
      break;
    case PROP_REGION_NAME:
      fo_region_after_set_region_name (fo_fo, g_value_get_object (value));
      break;
    case PROP_WRITING_MODE:
      fo_region_after_set_writing_mode (fo_fo, g_value_get_object (value));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
 ...
 **/
void
fo_region_after_validate (FoFo      *fo,
                          FoContext *current_context,
                          FoContext *parent_context,
                          GError   **error)
{
  ...
  fo_context_util_margins_indents_resolve (fo, current_context, parent_context);
  fo_context_util_margins_resolve (current_context, parent_context);
  fo_context_merge (current_context, parent_context);
  fo_fo_update_from_context (fo, current_context);

  region_name_datatype =
    fo_property_get_value (fo_region_after_get_region_name (fo));
...
/**
 * fo_region_after_update_from_context:
 * @fo:      The #FoFo object.
 ...
 **/
void
fo_region_after_update_from_context (FoFo      *fo,
                                     FoContext *context)
{
  g_return_if_fail (fo != NULL);
  g_return_if_fail (FO_IS_REGION_AFTER (fo));
  ...
  fo_region_after_set_background_color (fo,
			  fo_context_get_background_color (context));
  fo_region_after_set_background_image (fo,
			  fo_context_get_background_image (context));
  fo_region_after_set_border_after_color (fo,
			  fo_context_get_border_after_color (context));
  fo_region_after_set_border_after_style (fo,
			  fo_context_get_border_after_style (context));
  fo_region_after_set_border_after_width (fo,
			  fo_context_get_border_after_width (context));
  fo_region_after_set_border_before_color (fo,
			  fo_context_get_border_before_color (context));
  fo_region_after_set_border_before_style (fo,
			  fo_context_get_border_before_style (context));
  fo_region_after_set_border_before_width (fo,
			  fo_context_get_border_before_width (context));
  fo_region_after_set_border_bottom_color (fo,
			  fo_context_get_border_bottom_color (context));
  fo_region_after_set_border_bottom_style (fo,
			  fo_context_get_border_bottom_style (context));
  fo_region_after_set_border_bottom_width (fo,
			  fo_context_get_border_bottom_width (context));
  fo_region_after_set_border_end_color (fo,
			  fo_context_get_border_end_color (context));
  fo_region_after_set_border_end_style (fo,
			  fo_context_get_border_end_style (context));
  fo_region_after_set_border_end_width (fo,
			  fo_context_get_border_end_width (context));
  fo_region_after_set_border_left_color (fo,
			  fo_context_get_border_left_color (context));
  fo_region_after_set_border_left_style (fo,
			  fo_context_get_border_left_style (context));
  fo_region_after_set_border_left_width (fo,
			  fo_context_get_border_left_width (context));
  fo_region_after_set_border_right_color (fo,
			  fo_context_get_border_right_color (context));
  fo_region_after_set_border_right_style (fo,
			  fo_context_get_border_right_style (context));
  fo_region_after_set_border_right_width (fo,
			  fo_context_get_border_right_width (context));
  fo_region_after_set_border_start_color (fo,
			  fo_context_get_border_start_color (context));
  fo_region_after_set_border_start_style (fo,
			  fo_context_get_border_start_style (context));
  fo_region_after_set_border_start_width (fo,
			  fo_context_get_border_start_width (context));
  fo_region_after_set_border_top_color (fo,
			  fo_context_get_border_top_color (context));
  fo_region_after_set_border_top_style (fo,
			  fo_context_get_border_top_style (context));
  fo_region_after_set_border_top_width (fo,
			  fo_context_get_border_top_width (context));
  fo_region_after_set_clip (fo,
			  fo_context_get_clip (context));
  fo_region_after_set_display_align (fo,
			  fo_context_get_display_align (context));
  fo_region_after_set_extent (fo,
			  fo_context_get_extent (context));
  fo_region_after_set_overflow (fo,
			  fo_context_get_overflow (context));
  fo_region_after_set_padding_after (fo,
			  fo_context_get_padding_after (context));
  fo_region_after_set_padding_before (fo,
			  fo_context_get_padding_before (context));
  fo_region_after_set_padding_bottom (fo,
			  fo_context_get_padding_bottom (context));
  fo_region_after_set_padding_end (fo,
			  fo_context_get_padding_end (context));
  fo_region_after_set_padding_left (fo,
			  fo_context_get_padding_left (context));
  fo_region_after_set_padding_right (fo,
			  fo_context_get_padding_right (context));
  fo_region_after_set_padding_start (fo,
			  fo_context_get_padding_start (context));
  fo_region_after_set_padding_top (fo,
			  fo_context_get_padding_top (context));
  fo_region_after_set_region_name (fo,
			  fo_context_get_region_name (context));
  fo_region_after_set_writing_mode (fo,
			  fo_context_get_writing_mode (context));
}

/**
 * fo_region_after_debug_dump_properties:
 * @fo:    The #FoFo object.
 ...
 **/
void
fo_region_after_debug_dump_properties (FoFo *fo,
                                       gint  depth)
{
  FoRegionAfter *fo_region_after;
  ...
  fo_region_after = FO_REGION_AFTER (fo);

  fo_object_debug_dump (fo_region_after->background_color, depth);
  fo_object_debug_dump (fo_region_after->background_image, depth);
  fo_object_debug_dump (fo_region_after->border_after_color, depth);
  fo_object_debug_dump (fo_region_after->border_after_style, depth);
  fo_object_debug_dump (fo_region_after->border_after_width, depth);
  fo_object_debug_dump (fo_region_after->border_before_color, depth);
  fo_object_debug_dump (fo_region_after->border_before_style, depth);
  fo_object_debug_dump (fo_region_after->border_before_width, depth);
  fo_object_debug_dump (fo_region_after->border_bottom_color, depth);
  fo_object_debug_dump (fo_region_after->border_bottom_style, depth);
  fo_object_debug_dump (fo_region_after->border_bottom_width, depth);
  fo_object_debug_dump (fo_region_after->border_end_color, depth);
  fo_object_debug_dump (fo_region_after->border_end_style, depth);
  fo_object_debug_dump (fo_region_after->border_end_width, depth);
  fo_object_debug_dump (fo_region_after->border_left_color, depth);
  fo_object_debug_dump (fo_region_after->border_left_style, depth);
  fo_object_debug_dump (fo_region_after->border_left_width, depth);
  fo_object_debug_dump (fo_region_after->border_right_color, depth);
  fo_object_debug_dump (fo_region_after->border_right_style, depth);
  fo_object_debug_dump (fo_region_after->border_right_width, depth);
  fo_object_debug_dump (fo_region_after->border_start_color, depth);
  fo_object_debug_dump (fo_region_after->border_start_style, depth);
  fo_object_debug_dump (fo_region_after->border_start_width, depth);
  fo_object_debug_dump (fo_region_after->border_top_color, depth);
  fo_object_debug_dump (fo_region_after->border_top_style, depth);
  fo_object_debug_dump (fo_region_after->border_top_width, depth);
  fo_object_debug_dump (fo_region_after->clip, depth);
  fo_object_debug_dump (fo_region_after->display_align, depth);
  fo_object_debug_dump (fo_region_after->extent, depth);
  fo_object_debug_dump (fo_region_after->overflow, depth);
  fo_object_debug_dump (fo_region_after->padding_after, depth);
  fo_object_debug_dump (fo_region_after->padding_before, depth);
  fo_object_debug_dump (fo_region_after->padding_bottom, depth);
  fo_object_debug_dump (fo_region_after->padding_end, depth);
  fo_object_debug_dump (fo_region_after->padding_left, depth);
  fo_object_debug_dump (fo_region_after->padding_right, depth);
  fo_object_debug_dump (fo_region_after->padding_start, depth);
  fo_object_debug_dump (fo_region_after->padding_top, depth);
  fo_object_debug_dump (fo_region_after->region_name, depth);
  fo_object_debug_dump (fo_region_after->writing_mode, depth);
...
**/
FoProperty*
fo_region_after_get_background_color (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;

  g_return_val_if_fail (fo_region_after != NULL, NULL);
  g_return_val_if_fail (FO_IS_REGION_AFTER (fo_region_after), NULL);

  return fo_region_after->background_color;
}
 ...
 **/
void
fo_region_after_set_background_color (FoFo *fo_fo,
		         FoProperty *new_background_color)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;

  g_return_if_fail (fo_region_after != NULL);
  g_return_if_fail (FO_IS_REGION_AFTER (fo_region_after));
  ...
  if (fo_region_after->background_color != NULL)
    {
      g_object_unref (fo_region_after->background_color);
    }
  fo_region_after->background_color = new_background_color;
  /*g_object_notify (G_OBJECT (fo_region_after), "background-color");*/
}
...
**/
FoProperty*
fo_region_after_get_background_image (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->background_image;
}
 ...
 **/
void
fo_region_after_set_background_image (FoFo *fo_fo,
		         FoProperty *new_background_image)
{
  ...
  if (fo_region_after->background_image != NULL)
    {
      g_object_unref (fo_region_after->background_image);
    }
  fo_region_after->background_image = new_background_image;
  /*g_object_notify (G_OBJECT (fo_region_after), "background-image");*/
}
...
**/
FoProperty*
fo_region_after_get_border_after_color (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_after_color;
}
 ...
 **/
void
fo_region_after_set_border_after_color (FoFo *fo_fo,
		         FoProperty *new_border_after_color)
{
  ...
  if (fo_region_after->border_after_color != NULL)
    {
      g_object_unref (fo_region_after->border_after_color);
    }
  fo_region_after->border_after_color = new_border_after_color;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-after-color");*/
}
...
**/
FoProperty*
fo_region_after_get_border_after_style (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_after_style;
}
 ...
 **/
void
fo_region_after_set_border_after_style (FoFo *fo_fo,
		         FoProperty *new_border_after_style)
{
  ...
  if (fo_region_after->border_after_style != NULL)
    {
      g_object_unref (fo_region_after->border_after_style);
    }
  fo_region_after->border_after_style = new_border_after_style;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-after-style");*/
}
...
**/
FoProperty*
fo_region_after_get_border_after_width (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_after_width;
}
 ...
 **/
void
fo_region_after_set_border_after_width (FoFo *fo_fo,
		         FoProperty *new_border_after_width)
{
  ...
  if (fo_region_after->border_after_width != NULL)
    {
      g_object_unref (fo_region_after->border_after_width);
    }
  fo_region_after->border_after_width = new_border_after_width;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-after-width");*/
}
...
**/
FoProperty*
fo_region_after_get_border_before_color (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_before_color;
}
 ...
 **/
void
fo_region_after_set_border_before_color (FoFo *fo_fo,
		         FoProperty *new_border_before_color)
{
  ...
  if (fo_region_after->border_before_color != NULL)
    {
      g_object_unref (fo_region_after->border_before_color);
    }
  fo_region_after->border_before_color = new_border_before_color;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-before-color");*/
}
...
**/
FoProperty*
fo_region_after_get_border_before_style (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_before_style;
}
 ...
 **/
void
fo_region_after_set_border_before_style (FoFo *fo_fo,
		         FoProperty *new_border_before_style)
{
  ...
  if (fo_region_after->border_before_style != NULL)
    {
      g_object_unref (fo_region_after->border_before_style);
    }
  fo_region_after->border_before_style = new_border_before_style;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-before-style");*/
}
...
**/
FoProperty*
fo_region_after_get_border_before_width (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_before_width;
}
 ...
 **/
void
fo_region_after_set_border_before_width (FoFo *fo_fo,
		         FoProperty *new_border_before_width)
{
  ...
  if (fo_region_after->border_before_width != NULL)
    {
      g_object_unref (fo_region_after->border_before_width);
    }
  fo_region_after->border_before_width = new_border_before_width;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-before-width");*/
}
...
**/
FoProperty*
fo_region_after_get_border_bottom_color (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_bottom_color;
}
 ...
 **/
void
fo_region_after_set_border_bottom_color (FoFo *fo_fo,
		         FoProperty *new_border_bottom_color)
{
  ...
  if (fo_region_after->border_bottom_color != NULL)
    {
      g_object_unref (fo_region_after->border_bottom_color);
    }
  fo_region_after->border_bottom_color = new_border_bottom_color;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-bottom-color");*/
}
...
**/
FoProperty*
fo_region_after_get_border_bottom_style (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_bottom_style;
}
 ...
 **/
void
fo_region_after_set_border_bottom_style (FoFo *fo_fo,
		         FoProperty *new_border_bottom_style)
{
  ...
  if (fo_region_after->border_bottom_style != NULL)
    {
      g_object_unref (fo_region_after->border_bottom_style);
    }
  fo_region_after->border_bottom_style = new_border_bottom_style;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-bottom-style");*/
}
...
**/
FoProperty*
fo_region_after_get_border_bottom_width (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_bottom_width;
}
 ...
 **/
void
fo_region_after_set_border_bottom_width (FoFo *fo_fo,
		         FoProperty *new_border_bottom_width)
{
  ...
  if (fo_region_after->border_bottom_width != NULL)
    {
      g_object_unref (fo_region_after->border_bottom_width);
    }
  fo_region_after->border_bottom_width = new_border_bottom_width;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-bottom-width");*/
}
...
**/
FoProperty*
fo_region_after_get_border_end_color (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_end_color;
}
 ...
 **/
void
fo_region_after_set_border_end_color (FoFo *fo_fo,
		         FoProperty *new_border_end_color)
{
  ...
  if (fo_region_after->border_end_color != NULL)
    {
      g_object_unref (fo_region_after->border_end_color);
    }
  fo_region_after->border_end_color = new_border_end_color;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-end-color");*/
}
...
**/
FoProperty*
fo_region_after_get_border_end_style (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_end_style;
}
 ...
 **/
void
fo_region_after_set_border_end_style (FoFo *fo_fo,
		         FoProperty *new_border_end_style)
{
  ...
  if (fo_region_after->border_end_style != NULL)
    {
      g_object_unref (fo_region_after->border_end_style);
    }
  fo_region_after->border_end_style = new_border_end_style;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-end-style");*/
}
...
**/
FoProperty*
fo_region_after_get_border_end_width (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_end_width;
}
 ...
 **/
void
fo_region_after_set_border_end_width (FoFo *fo_fo,
		         FoProperty *new_border_end_width)
{
  ...
  if (fo_region_after->border_end_width != NULL)
    {
      g_object_unref (fo_region_after->border_end_width);
    }
  fo_region_after->border_end_width = new_border_end_width;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-end-width");*/
}
...
**/
FoProperty*
fo_region_after_get_border_left_color (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_left_color;
}
 ...
 **/
void
fo_region_after_set_border_left_color (FoFo *fo_fo,
		         FoProperty *new_border_left_color)
{
  ...
  if (fo_region_after->border_left_color != NULL)
    {
      g_object_unref (fo_region_after->border_left_color);
    }
  fo_region_after->border_left_color = new_border_left_color;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-left-color");*/
}
...
**/
FoProperty*
fo_region_after_get_border_left_style (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_left_style;
}
 ...
 **/
void
fo_region_after_set_border_left_style (FoFo *fo_fo,
		         FoProperty *new_border_left_style)
{
  ...
  if (fo_region_after->border_left_style != NULL)
    {
      g_object_unref (fo_region_after->border_left_style);
    }
  fo_region_after->border_left_style = new_border_left_style;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-left-style");*/
}
...
**/
FoProperty*
fo_region_after_get_border_left_width (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_left_width;
}
 ...
 **/
void
fo_region_after_set_border_left_width (FoFo *fo_fo,
		         FoProperty *new_border_left_width)
{
  ...
  if (fo_region_after->border_left_width != NULL)
    {
      g_object_unref (fo_region_after->border_left_width);
    }
  fo_region_after->border_left_width = new_border_left_width;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-left-width");*/
}
...
**/
FoProperty*
fo_region_after_get_border_right_color (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_right_color;
}
 ...
 **/
void
fo_region_after_set_border_right_color (FoFo *fo_fo,
		         FoProperty *new_border_right_color)
{
  ...
  if (fo_region_after->border_right_color != NULL)
    {
      g_object_unref (fo_region_after->border_right_color);
    }
  fo_region_after->border_right_color = new_border_right_color;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-right-color");*/
}
...
**/
FoProperty*
fo_region_after_get_border_right_style (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_right_style;
}
 ...
 **/
void
fo_region_after_set_border_right_style (FoFo *fo_fo,
		         FoProperty *new_border_right_style)
{
  ...
  if (fo_region_after->border_right_style != NULL)
    {
      g_object_unref (fo_region_after->border_right_style);
    }
  fo_region_after->border_right_style = new_border_right_style;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-right-style");*/
}
...
**/
FoProperty*
fo_region_after_get_border_right_width (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_right_width;
}
 ...
 **/
void
fo_region_after_set_border_right_width (FoFo *fo_fo,
		         FoProperty *new_border_right_width)
{
  ...
  if (fo_region_after->border_right_width != NULL)
    {
      g_object_unref (fo_region_after->border_right_width);
    }
  fo_region_after->border_right_width = new_border_right_width;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-right-width");*/
}
...
**/
FoProperty*
fo_region_after_get_border_start_color (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_start_color;
}
 ...
 **/
void
fo_region_after_set_border_start_color (FoFo *fo_fo,
		         FoProperty *new_border_start_color)
{
  ...
  if (fo_region_after->border_start_color != NULL)
    {
      g_object_unref (fo_region_after->border_start_color);
    }
  fo_region_after->border_start_color = new_border_start_color;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-start-color");*/
}
...
**/
FoProperty*
fo_region_after_get_border_start_style (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_start_style;
}
 ...
 **/
void
fo_region_after_set_border_start_style (FoFo *fo_fo,
		         FoProperty *new_border_start_style)
{
  ...
  if (fo_region_after->border_start_style != NULL)
    {
      g_object_unref (fo_region_after->border_start_style);
    }
  fo_region_after->border_start_style = new_border_start_style;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-start-style");*/
}
...
**/
FoProperty*
fo_region_after_get_border_start_width (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_start_width;
}
 ...
 **/
void
fo_region_after_set_border_start_width (FoFo *fo_fo,
		         FoProperty *new_border_start_width)
{
  ...
  if (fo_region_after->border_start_width != NULL)
    {
      g_object_unref (fo_region_after->border_start_width);
    }
  fo_region_after->border_start_width = new_border_start_width;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-start-width");*/
}
...
**/
FoProperty*
fo_region_after_get_border_top_color (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_top_color;
}
 ...
 **/
void
fo_region_after_set_border_top_color (FoFo *fo_fo,
		         FoProperty *new_border_top_color)
{
  ...
  if (fo_region_after->border_top_color != NULL)
    {
      g_object_unref (fo_region_after->border_top_color);
    }
  fo_region_after->border_top_color = new_border_top_color;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-top-color");*/
}
...
**/
FoProperty*
fo_region_after_get_border_top_style (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_top_style;
}
 ...
 **/
void
fo_region_after_set_border_top_style (FoFo *fo_fo,
		         FoProperty *new_border_top_style)
{
  ...
  if (fo_region_after->border_top_style != NULL)
    {
      g_object_unref (fo_region_after->border_top_style);
    }
  fo_region_after->border_top_style = new_border_top_style;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-top-style");*/
}
...
**/
FoProperty*
fo_region_after_get_border_top_width (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->border_top_width;
}
 ...
 **/
void
fo_region_after_set_border_top_width (FoFo *fo_fo,
		         FoProperty *new_border_top_width)
{
  ...
  if (fo_region_after->border_top_width != NULL)
    {
      g_object_unref (fo_region_after->border_top_width);
    }
  fo_region_after->border_top_width = new_border_top_width;
  /*g_object_notify (G_OBJECT (fo_region_after), "border-top-width");*/
}
...
**/
FoProperty*
fo_region_after_get_clip (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
 ...
 **/
void
fo_region_after_set_clip (FoFo *fo_fo,
		         FoProperty *new_clip)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  if (fo_region_after->clip != NULL)
    {
      g_object_unref (fo_region_after->clip);
    }
  fo_region_after->clip = new_clip;
  /*g_object_notify (G_OBJECT (fo_region_after), "clip");*/
}
...
**/
FoProperty*
fo_region_after_get_display_align (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->display_align;
}
 ...
 **/
void
fo_region_after_set_display_align (FoFo *fo_fo,
		         FoProperty *new_display_align)
{
  ...
  if (fo_region_after->display_align != NULL)
    {
      g_object_unref (fo_region_after->display_align);
    }
  fo_region_after->display_align = new_display_align;
  /*g_object_notify (G_OBJECT (fo_region_after), "display-align");*/
}
...
**/
FoProperty*
fo_region_after_get_extent (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
 ...
 **/
void
fo_region_after_set_extent (FoFo *fo_fo,
		         FoProperty *new_extent)
{
  ...
  if (fo_region_after->extent != NULL)
    {
      g_object_unref (fo_region_after->extent);
    }
  fo_region_after->extent = new_extent;
  /*g_object_notify (G_OBJECT (fo_region_after), "extent");*/
}
...
**/
FoProperty*
fo_region_after_get_overflow (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->overflow;
}
 ...
 **/
void
fo_region_after_set_overflow (FoFo *fo_fo,
		         FoProperty *new_overflow)
{
  ...
  if (fo_region_after->overflow != NULL)
    {
      g_object_unref (fo_region_after->overflow);
    }
  fo_region_after->overflow = new_overflow;
  /*g_object_notify (G_OBJECT (fo_region_after), "overflow");*/
}
...
**/
FoProperty*
fo_region_after_get_padding_after (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->padding_after;
}
 ...
 **/
void
fo_region_after_set_padding_after (FoFo *fo_fo,
		         FoProperty *new_padding_after)
{
  ...
  if (fo_region_after->padding_after != NULL)
    {
      g_object_unref (fo_region_after->padding_after);
    }
  fo_region_after->padding_after = new_padding_after;
  /*g_object_notify (G_OBJECT (fo_region_after), "padding-after");*/
}
...
**/
FoProperty*
fo_region_after_get_padding_before (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->padding_before;
}
 ...
 **/
void
fo_region_after_set_padding_before (FoFo *fo_fo,
		         FoProperty *new_padding_before)
{
  ...
  if (fo_region_after->padding_before != NULL)
    {
      g_object_unref (fo_region_after->padding_before);
    }
  fo_region_after->padding_before = new_padding_before;
  /*g_object_notify (G_OBJECT (fo_region_after), "padding-before");*/
}
...
**/
FoProperty*
fo_region_after_get_padding_bottom (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->padding_bottom;
}
 ...
 **/
void
fo_region_after_set_padding_bottom (FoFo *fo_fo,
		         FoProperty *new_padding_bottom)
{
  ...
  if (fo_region_after->padding_bottom != NULL)
    {
      g_object_unref (fo_region_after->padding_bottom);
    }
  fo_region_after->padding_bottom = new_padding_bottom;
  /*g_object_notify (G_OBJECT (fo_region_after), "padding-bottom");*/
}
...
**/
FoProperty*
fo_region_after_get_padding_end (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->padding_end;
}
 ...
 **/
void
fo_region_after_set_padding_end (FoFo *fo_fo,
		         FoProperty *new_padding_end)
{
  ...
  if (fo_region_after->padding_end != NULL)
    {
      g_object_unref (fo_region_after->padding_end);
    }
  fo_region_after->padding_end = new_padding_end;
  /*g_object_notify (G_OBJECT (fo_region_after), "padding-end");*/
}
...
**/
FoProperty*
fo_region_after_get_padding_left (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->padding_left;
}
 ...
 **/
void
fo_region_after_set_padding_left (FoFo *fo_fo,
		         FoProperty *new_padding_left)
{
  ...
  if (fo_region_after->padding_left != NULL)
    {
      g_object_unref (fo_region_after->padding_left);
    }
  fo_region_after->padding_left = new_padding_left;
  /*g_object_notify (G_OBJECT (fo_region_after), "padding-left");*/
}
...
**/
FoProperty*
fo_region_after_get_padding_right (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->padding_right;
}
 ...
 **/
void
fo_region_after_set_padding_right (FoFo *fo_fo,
		         FoProperty *new_padding_right)
{
  ...
  if (fo_region_after->padding_right != NULL)
    {
      g_object_unref (fo_region_after->padding_right);
    }
  fo_region_after->padding_right = new_padding_right;
  /*g_object_notify (G_OBJECT (fo_region_after), "padding-right");*/
}
...
**/
FoProperty*
fo_region_after_get_padding_start (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->padding_start;
}
 ...
 **/
void
fo_region_after_set_padding_start (FoFo *fo_fo,
		         FoProperty *new_padding_start)
{
  ...
  if (fo_region_after->padding_start != NULL)
    {
      g_object_unref (fo_region_after->padding_start);
    }
  fo_region_after->padding_start = new_padding_start;
  /*g_object_notify (G_OBJECT (fo_region_after), "padding-start");*/
}
...
**/
FoProperty*
fo_region_after_get_padding_top (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->padding_top;
}
 ...
 **/
void
fo_region_after_set_padding_top (FoFo *fo_fo,
		         FoProperty *new_padding_top)
{
  ...
  if (fo_region_after->padding_top != NULL)
    {
      g_object_unref (fo_region_after->padding_top);
    }
  fo_region_after->padding_top = new_padding_top;
  /*g_object_notify (G_OBJECT (fo_region_after), "padding-top");*/
}
...
**/
FoProperty*
fo_region_after_get_region_name (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->region_name;
}
 ...
 **/
void
fo_region_after_set_region_name (FoFo *fo_fo,
		         FoProperty *new_region_name)
{
  ...
  if (fo_region_after->region_name != NULL)
    {
      g_object_unref (fo_region_after->region_name);
    }
  fo_region_after->region_name = new_region_name;
  /*g_object_notify (G_OBJECT (fo_region_after), "region-name");*/
}
...
**/
FoProperty*
fo_region_after_get_writing_mode (FoFo *fo_fo)
{
  FoRegionAfter *fo_region_after = (FoRegionAfter *) fo_fo;
  ...
  return fo_region_after->writing_mode;
}
 ...
 **/
void
fo_region_after_set_writing_mode (FoFo *fo_fo,
		         FoProperty *new_writing_mode)
{
  ...
  if (fo_region_after->writing_mode != NULL)
    {
      g_object_unref (fo_region_after->writing_mode);
    }
  fo_region_after->writing_mode = new_writing_mode;
  /*g_object_notify (G_OBJECT (fo_region_after), "writing-mode");*/
}
