 ...
 *
 * $Id: fo-list-item-body-area.c,v 1.3 2003/05/23 16:36:48 tonygraham Exp $
 *
...
void
fo_list_item_body_area_new (FoFo    *fo,
			    FoDoc   *fo_doc,
			    FoArea  *parent_area,
			    FoArea **new_area,
			    guint    debug_level)
{
  ...
  *new_area = fo_area_area_new ();
  ...
  g_warning ("*** list-item-body parent before new area:");
  fo_object_debug_dump (parent_area, 0);
  g_warning ("*** end list-item-body parent");
#endif
...
#if defined(LIBFO_DEBUG) && 0
  g_warning ("*** list-item-body parent after new area:");
  fo_object_debug_dump (parent_area, 0);
  g_warning ("*** end list-item-body parent");
#endif
...
#if defined(LIBFO_DEBUG) && 0
  g_warning ("*** list-item-body parent after adding children:");
  fo_object_debug_dump (parent_area, 0);
  g_warning ("*** end list-item-body parent");
#endif
}
