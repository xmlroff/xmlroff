 ...
 *
 * $Id: fo-table-border-fo.c,v 1.3 2005/01/03 21:01:36 tonygraham Exp $
 *
  ...
  if (!table_border_fo_type)
	...
	NULL		/* value_table */
      ...
      table_border_fo_type = g_type_register_static (G_TYPE_INTERFACE,
					      ...
					      &table_border_fo_info, 0);
      g_type_interface_add_prerequisite (table_border_fo_type, FO_TYPE_FO);
    }
